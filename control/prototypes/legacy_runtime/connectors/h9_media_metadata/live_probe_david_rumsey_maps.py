"""Source-specific fail-closed H9 live-probe wrapper for David Rumsey Map Collection metadata."""
...
def build_request_url_or_metadata_request(request: Mapping[str, Any], policy_bundle: Mapping[str, Any]) -> dict[str, Any]:
    ...
    if request.get("source_id") != SOURCE_ID:
        raise ValueError("request source_id does not match david_rumsey_maps")
