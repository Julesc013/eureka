"""Source-specific fail-closed H10 live-probe wrapper for itch.io game metadata, policy-limited."""
...
def build_request_url_or_metadata_request(request: Mapping[str, Any], policy_bundle: Mapping[str, Any]) -> dict[str, Any]:
    ...
    if request.get("source_id") != SOURCE_ID:
        raise ValueError("request source_id does not match itchio_game_metadata_policy_limited")
