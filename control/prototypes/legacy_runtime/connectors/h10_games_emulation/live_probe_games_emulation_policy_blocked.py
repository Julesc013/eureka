"""Source-specific fail-closed H10 live-probe wrapper for Generic game/software identity policy-blocked source."""
...
from control.prototypes.legacy_runtime.connectors.h10_games_emulation.live_probe_common import (
    SOURCE_CONFIGS,
...
def build_request_url_or_metadata_request(request: Mapping[str, Any], policy_bundle: Mapping[str, Any]) -> dict[str, Any]:
    ...
    if request.get("source_id") != SOURCE_ID:
        raise ValueError("request source_id does not match games_emulation_policy_blocked")
