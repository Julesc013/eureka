"""Source-specific H6 live-probe metadata wrapper for restricted_public_document_manifest."""
...
from control.prototypes.legacy_runtime.connectors.h6_web_archive_news_event.live_probe_common import build_metadata_request, normalize_h6_web_archive_live_probe_result, parse_metadata_response

SOURCE_ID = "restricted_public_document_manifest"
