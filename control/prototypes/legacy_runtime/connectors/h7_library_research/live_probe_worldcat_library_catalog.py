"""Fail-closed H7 metadata live-probe wrapper for worldcat_library_catalog."""
...
SOURCE_ID = "worldcat_library_catalog"
DEFAULT_ENDPOINT_OR_METADATA_CLASS = "catalog_record_metadata_lookup_future"
