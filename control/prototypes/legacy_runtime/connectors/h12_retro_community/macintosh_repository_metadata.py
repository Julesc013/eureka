"""Fixture-only normalizer for macintosh_repository_metadata."""
...
def normalize(raw_fixture: Mapping[str, Any], policy: Mapping[str, Any] | None = None) -> dict[str, Any]:
    return normalize_h12_retro_community_fixture(raw_fixture, "macintosh_repository_metadata", policy)
