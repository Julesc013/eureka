"""Source-specific H12 live-probe wrapper for betaarchive_public_metadata_policy_limited."""
...
from control.prototypes.legacy_runtime.connectors.h12_retro_community.live_probe_common import SOURCE_CONFIGS, _normal_record_from_response

SOURCE_ID = "betaarchive_public_metadata_policy_limited"
