...
| --- | --- | --- | --- |
| `public_data_summaries` | generated | `python scripts/generate_public_data_summaries.py --check` | `public_site/data/*.json` must match generator output. |
| `compatibility_surfaces` | generated | `python scripts/generate_compatibility_surfaces.py --check` | `public_site/lite`, `text`, and `files` must match generator output. |
...
| `site_dist` | generated validation output | `python site/build.py --check` | `site/dist` is checked by rebuilding into a temporary directory. |
