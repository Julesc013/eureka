...
- Status: `valid`
- Tracked files inspected: `20946`
- Tracked `site/dist/` files: `58`
- Tracked `tmp/` files: `0`
- Tracked paths with `/dist/`: `62`
- Tracked paths with `/build/`: `4`
- Tracked paths with `/out/`: `0`
- Tracked paths with `/target/`: `0`
- Tracked paths with `/coverage/`: `71`
