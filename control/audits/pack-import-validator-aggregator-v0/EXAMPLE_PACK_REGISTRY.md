...
| --- | --- | --- |
| `source_pack` | `examples/packs/source/minimal_recorded_source_pack_v0` | pass |
| `evidence_pack` | `examples/packs/evidence/minimal_evidence_pack_v0` | pass |
| `index_pack` | `examples/packs/index/minimal_index_pack_v0` | pass |
| `contribution_pack` | `examples/packs/contribution/minimal_contribution_pack_v0` | pass |
