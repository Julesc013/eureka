...
Phase 2: local approved live metadata probe only after human/operator approval, strict URI privacy, User-Agent/contact, rate-limit, timeout, cache, no public search fanout, and no archived content fetch.
