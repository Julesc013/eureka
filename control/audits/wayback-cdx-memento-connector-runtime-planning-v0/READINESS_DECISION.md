...
- The Wayback/CDX/Memento connector approval pack exists.
...
- URI privacy review and source policy review are not complete.
- User-Agent/contact values are not configured.
