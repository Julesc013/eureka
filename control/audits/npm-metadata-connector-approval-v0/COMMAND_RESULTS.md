...
## python scripts/validate_npm_metadata_connector_approval.py --all-examples
...
## python scripts/validate_npm_metadata_connector_approval.py --all-examples --json
  ...
  "results": [
    {
      "status": "valid",
      "created_by": "npm_metadata_connector_approval_validator_v0",
      "approval": "examples\\connectors\\npm_metadata_approval_v0\\NPM_METADATA_CONNECTOR_APPROVAL.json",
      "approval_record_id": "example.connector.npm_metadata.approval.v0",
      "errors": [],
      "warnings": [],
      "approval_root": "examples\\connectors\\npm_metadata_approval_v0"
    }
  ],
  "errors": [],
  "warnings": []
...
## python scripts/validate_npm_metadata_connector_contract.py
...
## python scripts/validate_npm_metadata_connector_contract.py --json
...
## python scripts/dry_run_npm_metadata_connector_approval.py --json
...
```
{
  ...
  "blocked_request_results": [
    ...
    },
    {
      ...
      "ok": false,
      "passed": true,
      "route": "/api/v1/search?q=xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
    },
    {
      "actual_error_code": "limit_too_large",
      "expected_error_code": "limit_too_large",
      "message": "Check passed.",
...
[PASS] stored export root: /api/stored?target_ref=fixture%3Asoftware%2Fsynthetic-demo-app%401.0.0&store_root=D%3A%
...<truncated>
```
...
```
{
  "created_at": "2026-05-05T09:43:53.015836+00:00",
  "created_by_slice": "archive_resolution_eval_runner_v0",
  "load_errors": [],
  "notices": [
    {
  ...
  "task_summaries": [
    {
      ...
      "not_evaluable_check_count": 0,
      "overall_status": "satisfied",
      "planner_expected_task_kind": "find_document_article",
      "planner_observed_task_kind": "find_document_article",
      "planner_status": "satisfied",
      "query_family": "article_inside_scan",
      "raw_query": "article inside 1994 magazine scan about ray tracing",
      "search_mode": "local_index",
      "search_observed_result_count": 9,
      "task_id": "article_inside_magazine_scan"
    },
    {
      "capabilit
...<truncated>
...
- identity_cluster_gap: 14 (Group ambiguous names, versions, 
...<truncated>
```
...
```
{
  "created_at": "2026-05-05T09:43:53.740896+00:00",
  "created_by_slice": "search_usefulness_audit_v0",
  ...
  "future_work_recommendations": [
    {
      "count": 49,
      "description": "Add governed source coverage or recorded fixtures for the observed query family.",
      "label": "source_coverage_gap"
    },
    {
      "count": 25,
      "description": "Add source-backed compatibility clues and host-profile evidence.",
  ...
  "batches": {
    "batch_0": {
      ...
      "next_pending_slots": [
        ...
        {
          "batch_id": "batch_0",
          "observation_id": "batch_0::windows_7_apps::internet_archive_full_text_search",
          "observation_status": "pending_manual_observation",
          "query_id": "windows_7_apps",
          "que
...<truncated>
...
warning: in the working copy of 'site/dist/demo/result-firef
...<truncated>
```
...
## main...origin/main
 ...
 M docs/reference/GITHUB_RELEASES_CONNECTOR_APPROVAL.md
