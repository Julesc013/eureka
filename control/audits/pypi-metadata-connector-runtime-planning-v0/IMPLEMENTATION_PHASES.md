...
Phase 2: local approved live metadata probe only after human/operator approval, strict package identity/User-Agent/contact/rate-limit/timeout/cache controls, token-free unless future explicit approval, no public search fanout, and no package download/install/dependency resolution.
