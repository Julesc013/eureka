...
```json
{
  "blockers": [
    ...
    },
    {
      ...
      "evidence": "Candidate/reviewed ratio is 28.0; candidates are not accepted truth.",
      "launch_blocking": true,
      "public_explanation": "Candidate/reviewed ratio is 28.0; candidates are not accepted truth.",
      "schema_version": "public_alpha_launch_blocker.v0",
      "severity": "launch_blocking"
    },
    {
    ...
    {
      "blocker_id": "no_live_metadata_batch_reviewed",
      "evidence": "No operator-approved live metadata pilot batch has been reviewed.",
      "launch_blocking": true,
      "public_explanation": "No operator-approved live metadata pilot batch has been reviewed.",
      "schema_version": "public_alpha_launch_blocker.v0",
      "severity": "launch_blocking"
    },
    {
      "blocker_id": "no_snapshot_publication_rehearsal_after_seed_refresh",
      "evidence": "The refreshed seed projection has not had a separate publication rehearsal.",
      "launch_blocking": true,
      "public_explanation": "The refreshed seed projection has not had a separate publication rehearsal.",
      "schema_version": "public_alpha_launch_blocker.v0",
      "severity": "launch_blocking"
    }
  ],
