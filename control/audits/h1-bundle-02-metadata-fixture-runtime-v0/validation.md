...
- `python -m json.tool contracts/control_schemas/fixtures/h1/connectors/metadata_fixture.v0.json`: PASS
- `python -m json.tool contracts/control_schemas/previews/h1/connectors/metadata_normalized_record.v0.json`: PASS
- `python -m json.tool contracts/control_schemas/fixtures/h1/connectors/metadata_fixture_replay_result.v0.json`: PASS
