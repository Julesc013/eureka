...
```json
{
  "blockers": [
    ...
    {
      "blocker_id": "public_search_ux_mvp_missing",
      "evidence": "Canonical view models exist, but the minimal no-JS public search UX MVP is not implemented.",
      "launch_blocking": true,
      "public_explanation": "Canonical view models exist, but the minimal no-JS public search UX MVP is not implemented.",
      "schema_version": "public_alpha_launch_blocker.v0",
      "severity": "launch_blocking"
    },
    {
    ...
    },
    {
      ...
      "evidence": "No publication rehearsal has run after the four-domain snapshot.",
      "launch_blocking": true,
      "public_explanation": "No publication rehearsal has run after the four-domain snapshot.",
      "schema_version": "public_alpha_launch_blocker.v0",
      "severity": "launch_blocking"
    },
    {
