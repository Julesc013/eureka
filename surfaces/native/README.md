...
Bootstrap now includes a first local CLI slice under `surfaces/cli/` that proves a second surface family can reuse the same public-boundary and shared-mapping seams already exercised by `surfaces/web/`.
