...
2. Local Public Search Runtime v0, only after contract and safety review
3. Public Search Static Handoff v0
4. Public Search Rehearsal v0
5. Search Usefulness Source Expansion v2, fixture-only
6. Source Pack Contract v0
7. Evidence Pack Contract v0
8. Index Pack Contract v0
9. Contribution Pack Contract v0
