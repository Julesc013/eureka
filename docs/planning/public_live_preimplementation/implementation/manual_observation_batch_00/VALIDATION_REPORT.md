...
```text
py -3 .aide/scripts/aide_lite.py pack --task "MANUAL-OBSERVATION-BATCH-00"
```

## Focused Tests

```text
py -3 -m unittest tests.evals.test_manual_observation_batch tests.evals.test_manual_observation_review_backlog tests.runtime.test_surface_manual_observation_projection
```
...
Review ledger decisions created: no.

Reviewed records created: no.
