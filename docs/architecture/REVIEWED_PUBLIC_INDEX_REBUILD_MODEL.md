...
`control/` stores policies and audit evidence. `contracts/index/master/` stores the governed schemas. `examples/` stores public-safe fixtures. No runtime code is added for B20.
