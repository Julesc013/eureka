...
P63 defines `contracts/schema/control/tasks/query/probe_queue_item.v0.json` and
...
P64 defines `contracts/schema/control/previews/query/candidate_index_record.v0.json` and
`contracts/schema/control/previews/query/candidate_lifecycle.v0.json`, synthetic object, evidence,
