# H9 Media Metadata Live Probe Model

The model separates request validation, source approval, endpoint metadata-class checks, blocked results, fixture-equivalent normalization, preview candidates, and health summaries.
