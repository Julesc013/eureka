# Local Private Source Family Model

The local/private family covers local sources, private sources, user-supplied sources, authenticated-user boundaries, restricted manifest-only sources, and policy-blocked sources.
