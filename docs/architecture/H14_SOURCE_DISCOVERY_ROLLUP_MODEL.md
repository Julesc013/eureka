# H14 Source Discovery Rollup Model

The model is a thin offline layer over H14 fixture normalization. Requests pass a committed policy gate, load allowlisted committed artifacts, build candidate/previews, and stop before any registry, pack, source-cache, evidence, public-index, or master-index mutation.
