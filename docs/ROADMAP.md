...
v0, Live Probe Gateway Contract v0, and Rust Query Planner Parity Candidate v0 now
mark the start of a more evidence-led backend phase. The next step is to define
the next compatibility/snapshot contract layer without adding live behavior.
