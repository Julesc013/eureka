...
Source Registry v0, Resolution Run Model v0, and Query Planner v0 now mark the
start of the operational backend phase. The next step is to give planned and
direct search work a stronger local retrieval substrate without prematurely
jumping to workers, public hosting, native app work, or a Rust rewrite.
