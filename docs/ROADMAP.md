...
v0 now mark the start of the operational backend phase. The next step is to
give local indexing, extraction, and run progression a bounded execution model
without prematurely jumping to public hosting, native app work, or a Rust
rewrite.
