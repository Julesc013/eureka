...
v0, and Live Probe Gateway Contract v0 now
mark the start of a more evidence-led backend phase. The next step is to define
the next isolated Rust query-planner parity candidate without wiring Rust into
