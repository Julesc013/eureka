...
v0, Live Probe Gateway Contract v0, Rust Query Planner Parity Candidate v0, Compatibility Surface Strategy v0, and Signed Snapshot Format v0 now
mark the start of a more evidence-led backend phase. The next step is to design
the relay surface contract without implementing relay services or network behavior.
