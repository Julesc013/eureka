...
Source Registry v0 now marks the start of the operational backend phase. The
next step is to introduce a bounded investigation or resolution-run envelope
