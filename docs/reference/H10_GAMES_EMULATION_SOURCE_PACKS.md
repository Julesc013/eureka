# H10 Games Emulation Source Packs

Defines source records, connector families, approval gates, coverage previews, scorecard previews, and source-pack manifests for games, emulation, ROM/software identity, compatibility, and preservation hash-set metadata.
