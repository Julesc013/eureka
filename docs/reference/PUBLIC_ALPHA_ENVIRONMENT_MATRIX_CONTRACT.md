# Public Alpha Environment Matrix Contract

Defines local fixture, local rehearsal, static-only, hosted-backend future, public-alpha future, and production future environments with launch disabled current.
