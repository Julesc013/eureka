# H13 Restricted Source Manifest Policy

Restricted source manifests may describe policy status without touching the source. They do not approve restricted access, scraping, crawling, bypassing, downloading, acquisition, or connector runtime.
