# Public Alpha Deployment Plan Contract

Defines the provider-neutral public alpha deployment plan packet. Current status is planning-only or operator-review-required.
