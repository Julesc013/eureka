# H13 Local CAS Import Boundary Policy

Local CAS import candidates are not import permission. H13-BUNDLE-01 does not hash, copy, deduplicate, import, store, export, or publish local files or blobs.
