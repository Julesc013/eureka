# H13 Local Source Identity Policy

Local source identity candidates use redacted or hashed locators and do not prove source truth, ownership, access authority, import permission, export permission, scan permission, extraction permission, or execution permission.
