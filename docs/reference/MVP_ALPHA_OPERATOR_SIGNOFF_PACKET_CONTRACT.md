# MVP Alpha Operator Signoff Packet Contract

Defines the signoff packet that a human may complete in a future reviewed task. Current packets are signoff_required or unsigned and cannot be used as approval.
