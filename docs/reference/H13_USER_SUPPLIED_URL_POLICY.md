# H13 User Supplied URL Policy

User-supplied URLs are not fetch permission. Arbitrary URL fetch, scraping, crawling, downloading, mirroring, indexing, and public fanout stay forbidden by default.
