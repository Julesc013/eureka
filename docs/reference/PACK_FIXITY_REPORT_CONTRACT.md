# Pack Fixity Report Contract

The fixity report records deterministic SHA-256 over local JSON serialization. Fixity is content identity only and does not prove authenticity.
