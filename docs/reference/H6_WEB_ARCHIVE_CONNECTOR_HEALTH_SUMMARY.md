# H6 Web Archive Connector Health Summary

Connector health summaries report preflight or metadata probe status only and do not claim production readiness.
