# H6 Web Archive Review Integration

H6 review integration turns explicit fixture replay outputs and blocked or approved metadata-only live-probe outputs into review seeds and previews. It does not accept web capture, time-state, event, article, public-document, source, evidence, candidate, privacy, safety, or public truth.
