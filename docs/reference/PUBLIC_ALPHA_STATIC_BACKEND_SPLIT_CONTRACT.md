# Public Alpha Static Backend Split Contract

Defines static, backend, files, status page, API alias, and old-browser alias roles without claiming a backend from a static site.
