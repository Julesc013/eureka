# H12 Retro Community Review Integration

H12 review integration reads committed fixture replay outputs and blocked or approved metadata-only live-probe outputs, then emits review seeds and previews only. It does not accept retro software identity, platform/version, archive item/member, compatibility, community-review, hash, IA/Wayback, gated-source, rights/safety, source, evidence, candidate, or public truth.
