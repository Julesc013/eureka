# H10 Platform Release Edition Policy

Platform, release, region, language, edition, version, variant, and media-type fields are release candidates only and do not prove compatibility or lawful acquisition.
