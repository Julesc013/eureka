# H10 Emulator Action Candidate Policy

Action candidates can record blocked metadata intentions such as view_metadata, compare_identity, inspect_manifest, or prepare_emulation_plan. Emulate, install, execute, acquire, download, and mirror remain blocked until a later Track J policy explicitly opens them.
