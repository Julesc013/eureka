# MVP Alpha Public Claim Review Contract

Defines allowed claims, forbidden claims, and required non-claims for public alpha copy and operator review packets.
