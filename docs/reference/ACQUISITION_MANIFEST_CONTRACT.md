...
It must not fetch, open external URLs, download, mirror, install, execute, emulate, or approve source access. Rights, malware safety, installability, and compatibility verification remain unknown unless future reviewed evidence says otherwise.
