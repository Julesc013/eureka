# H4 Release Identity Candidate

Release identity candidates carry tag, version, timestamp, notes, and actor metadata without proving authenticity or installability.
