# MVP Alpha Launch Blocker Register Contract

Defines launch, deployment, evidence, policy, hosting, source connector, and safety blockers that must remain visible to the operator.
