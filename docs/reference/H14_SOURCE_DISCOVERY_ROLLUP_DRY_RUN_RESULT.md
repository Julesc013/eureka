# H14 Source Discovery Rollup Dry-Run Result

The result contract groups rollup status, candidate arrays, source-cache and evidence previews, review seed previews, and Source OS health summaries. Result fields with access, model, mutation, pack, write, publication, and truth semantics must remain false.
