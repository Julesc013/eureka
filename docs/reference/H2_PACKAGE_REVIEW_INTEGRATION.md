# H2 Package Review Integration

Defines offline H2 review integration results, review seeds, and previews from committed fixture replay outputs and blocked or approved metadata-only live-probe outputs.
