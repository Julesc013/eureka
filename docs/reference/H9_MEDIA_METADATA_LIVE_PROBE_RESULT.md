# H9 Media Metadata Live Probe Result

Results are blocked, dry-run, or future bounded metadata observations. They may carry normalized records and candidates, but they are not media, music, visual, map, fingerprint, rights, safety, source, evidence, candidate, public, or production truth.
