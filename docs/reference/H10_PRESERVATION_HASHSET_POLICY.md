# H10 Preservation Hashset Policy

Preservation hash-set metadata can describe hash algorithms, values, file names, sizes, dump status, and collections, but it does not prove authenticity, lawful acquisition, malware safety, download rights, mirroring rights, or execution permission.
