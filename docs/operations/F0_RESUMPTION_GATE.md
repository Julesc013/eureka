...
F0 may resume only after R0-10 reports that the recovered runtime path is usable and all promotion blockers are resolved.
...
Current R0-10 decision: F0 remains blocked because contract taxonomy blockers remain unresolved. The next safe task is an R0 remediation task, not F0-BUNDLE-01.
