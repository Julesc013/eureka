# H6 Web Archive Live Probe No Fetch/Crawl Policy

WARC/WACZ fetches, page fetches, media downloads, scraping, crawling, browser automation, and bypass remain forbidden.
