# Pack Quarantine Review

Reviewers inspect quarantine results, blockers, fixity, signatures, provenance, and import previews before any future downstream action.
