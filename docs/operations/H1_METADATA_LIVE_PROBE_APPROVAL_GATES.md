# H1 Metadata Live Probe Approval Gates

Live access requires committed source approval, exact request-key approval, endpoint allowlisting, User-Agent/contact posture, timeout, retry, cache, kill switch, output path, review, and truth gates.
