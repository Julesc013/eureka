# H14 Source Discovery Rollup Registry Mutation Policy

Source and connector registries remain immutable in this wave. Rollup candidates can name future review needs, but cannot write registry entries, approve sources, approve connectors, or mutate public/master indexes.
