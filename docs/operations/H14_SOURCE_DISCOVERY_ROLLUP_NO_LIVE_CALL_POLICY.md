# H14 Source Discovery Rollup No-Live-Call Policy

No network calls, API calls, endpoint probes, source discovery runtime, web search, scraping, crawling, source sync, local/private access, user URL fetch, authenticated access, restricted access, model/provider calls, public query fanout, or hosted behavior is enabled.
