# H9 Media Metadata Live Probe Review

Source-cache, evidence, review queue, identity, relation, fingerprint, rights, and safety outputs remain previews and require separate review before any persistence or acceptance.
