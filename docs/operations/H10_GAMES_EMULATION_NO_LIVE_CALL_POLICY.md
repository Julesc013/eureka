# H10 Games Emulation No Live Call Policy

H10-BUNDLE-01 makes no live calls, API calls, endpoint probes, catalog queries, software-list fetches, hash-set fetches, source syncs, public query fanouts, hosted behavior, model/provider calls, scraping, crawling, or browser automation.
