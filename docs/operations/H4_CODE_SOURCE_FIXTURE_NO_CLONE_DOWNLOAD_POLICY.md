# H4 Code Source Fixture No Clone Download Policy

No repository clone, source archive download, release asset download, git command, build command, install, or execution is allowed.
