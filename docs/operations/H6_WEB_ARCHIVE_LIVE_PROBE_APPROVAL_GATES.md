# H6 Web Archive Live Probe Approval Gates

Every external call requires source-specific live access, metadata probe, request key, endpoint class, rate, cache, kill-switch, and output approvals.
