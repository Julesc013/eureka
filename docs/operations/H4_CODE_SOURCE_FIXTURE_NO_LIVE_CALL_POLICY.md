# H4 Code Source Fixture No Live Call Policy

The fixture runtime is offline; no live source calls, API calls, provider calls, or browser automation are allowed.
