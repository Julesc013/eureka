# H14 Source Discovery Rollup Blocked Mode

When any gate is missing, the CLI returns a blocked report with zero operations. Blocked reports may support H14-BUNDLE-04 review only as fixture-equivalent evidence and do not imply approval.
