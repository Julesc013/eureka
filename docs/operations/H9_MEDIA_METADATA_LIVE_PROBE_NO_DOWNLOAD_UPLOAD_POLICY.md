# H9 Media Metadata Live Probe No Download Upload Policy

Media, image, video, audio, map, score, thumbnail, cover, waveform, archive downloads, media uploads, user media upload, fingerprint submission, and fingerprint generation are forbidden in H9-BUNDLE-03.
