# MVP Alpha Launch Blockers

Current blockers are explicit operator signoff and real public launch evidence. Warnings preserve Track A naming, H1 approval-gated live probes, and manual native old-toolchain evidence.
