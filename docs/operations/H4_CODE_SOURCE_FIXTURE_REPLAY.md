# H4 Code Source Fixture Replay

Replay runs committed fixtures through offline normalizers and may write only explicit examples, audit generated files, or temp outputs.
