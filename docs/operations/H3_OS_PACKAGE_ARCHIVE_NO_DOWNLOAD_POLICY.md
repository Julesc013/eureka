# H3 OS Package Archive No Download Policy

H3-BUNDLE-01 forbids deb, rpm, pkg, tarball, source package, bottle, distfile, Nix store path, installer, flatpak, snap, repository index mirror, and package-manager outputs.
