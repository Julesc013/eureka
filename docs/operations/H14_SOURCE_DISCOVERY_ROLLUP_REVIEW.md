# H14 Source Discovery Rollup Review

Review consumes candidate and preview material only. Review is required before source discovery runtime, live access, model/provider use, source/connector registry changes, pack import/export, source-cache persistence, evidence acceptance, candidate acceptance, or index use.
