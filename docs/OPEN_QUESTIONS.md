...
80. For Hard Eval Satisfaction Pack v0, which source-backed candidate fields should satisfy the current archive-resolution hard expected-result hints without weakening task IDs, expected-result patterns, or bad-result guardrails?
