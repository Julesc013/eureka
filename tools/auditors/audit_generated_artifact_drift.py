...
DEFAULT_CLASSIFIERS = (
    ...
    ("site/dist/data/public_index", "canonical_generated"),
...
def build_report(
    ...
    *,
    ...
    return {
        ...
        "public_search_index_drift": any(item["path"].startswith("site/dist/data/public_index/") for item in drift_paths),
...
def suspected_source(path: str) -> str:
    ...
    if path.startswith("site/dist/data/public_index/"):
