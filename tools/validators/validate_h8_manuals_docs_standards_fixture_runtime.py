...
from archive.prototypes.legacy_runtime.connectors.h8_manuals_docs_standards.fixture_loader import load_h8_manuals_docs_fixture  # noqa: E402
from archive.prototypes.legacy_runtime.connectors.h8_manuals_docs_standards.normalizer_common import (  # noqa: E402
    H8_FIXTURE_KINDS,
    H8_SOURCE_IDS,
...
CONTRACT_FILES = ('contracts/control_schemas/fixtures/h8/connectors/manuals_docs_fixture.v0.json', 'contracts/control_schemas/previews/h8/connectors/manuals_docs_normalized_record.v0.json', 'contracts/control_schemas/previews/h8/connectors/technical_document_identity_candidate.v0.json', 'contracts/control_schemas/previews/h8/connectors/manual_artifact_relation_candidate.v0.json', 'contracts/control_schemas/previews/h8/connectors/datasheet_device_identity_candidate.v0.json', 'contracts/control_schemas/previews/h8/connectors/standards_specification_identity_candidate.v0.json', 'contracts/control_schemas/previews/h8/connectors/install_requirement_claim_candidate.v0.json', 'contracts/control_schemas/previews/h8/connectors/repair_service_safety_candidate.v0.json', 'contracts/control_schemas/previews/h8/connectors/access_rights_candidate.v0.json', 'contracts/control_schemas/fixtures/h8/connectors/manuals_docs_fixture_replay_result.v0.json')
...
def validate_repo(root: Path = REPO_ROOT) -> dict[str, Any]:
    ...
    for source_id in H8_SOURCE_IDS:
        ...
        required_paths.append(f"archive/prototypes/legacy_runtime/connectors/h8_manuals_docs_standards/{source_id}.py")
    required_paths.extend([
        "archive/prototypes/legacy_runtime/connectors/h8_manuals_docs_standards/__init__.py",
        "archive/prototypes/legacy_runtime/connectors/h8_manuals_docs_standards/fixture_loader.py",
        "archive/prototypes/legacy_runtime/connectors/h8_manuals_docs_standards/normalizer_common.py",
        "archive/prototypes/legacy_runtime/connectors/h8_manuals_docs_standards/technical_document_identity.py",
        "archive/prototypes/legacy_runtime/connectors/h8_manuals_docs_standards/manual_artifact_relation.py",
        "archive/prototypes/legacy_runtime/connectors/h8_manuals_docs_standards/datasheet_device_identity.py",
        "archive/prototypes/legacy_runtime/connectors/h8_manuals_docs_standards/standards_specification_identity.py",
        "archive/prototypes/legacy_runtime/connectors/h8_manuals_docs_standards/install_requirement_claim.py",
        "archive/prototypes/legacy_runtime/connectors/h8_manuals_docs_standards/repair_service_safety.py",
        "archive/prototypes/legacy_runtime/connectors/h8_manuals_docs_standards/access_rights.py",
    ])
...
def validate_fixtures(root: Path, errors: list[str]) -> None:
    for source_id in H8_SOURCE_IDS:
        normalizer = importlib.import_module(f"archive.prototypes.legacy_runtime.connectors.h8_manuals_docs_standards.{source_id}").normalize
        for kind in H8_FIXTURE_KINDS:
            filename = "policy_blocked_record.json" if kind == "policy_blocked" else f"{kind}_record.json"
...
def validate_runtime_imports(errors: list[str]) -> None:
    for source_id in H8_SOURCE_IDS:
        importlib.import_module(f"archive.prototypes.legacy_runtime.connectors.h8_manuals_docs_standards.{source_id}")
    for module in ("fixture_loader", "normalizer_common", "technical_document_identity", "manual_artifact_relation", "datasheet_device_identity", "standards_specification_identity", "install_requirement_claim", "repair_service_safety", "access_rights"):
        importlib.import_module(f"archive.prototypes.legacy_runtime.connectors.h8_manuals_docs_standards.{module}")


def validate_python_safety(root: Path, errors: list[str]) -> None:
    runtime_dir = root / "archive/prototypes/legacy_runtime/connectors/h8_manuals_docs_standards"
