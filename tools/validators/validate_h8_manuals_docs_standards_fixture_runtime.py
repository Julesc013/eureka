...
CONTRACT_FILES = ('contracts/schema/control/fixtures/h8/connectors/manuals_docs_fixture.v0.json', 'contracts/schema/control/previews/h8/connectors/manuals_docs_normalized_record.v0.json', 'contracts/schema/control/previews/h8/connectors/technical_document_identity_candidate.v0.json', 'contracts/schema/control/previews/h8/connectors/manual_artifact_relation_candidate.v0.json', 'contracts/schema/control/previews/h8/connectors/datasheet_device_identity_candidate.v0.json', 'contracts/schema/control/previews/h8/connectors/standards_specification_identity_candidate.v0.json', 'contracts/schema/control/previews/h8/connectors/install_requirement_claim_candidate.v0.json', 'contracts/schema/control/previews/h8/connectors/repair_service_safety_candidate.v0.json', 'contracts/schema/control/previews/h8/connectors/access_rights_candidate.v0.json', 'contracts/schema/control/fixtures/h8/connectors/manuals_docs_fixture_replay_result.v0.json')
