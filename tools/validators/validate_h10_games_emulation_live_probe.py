...
CONTRACTS = tuple(['contracts/schema/control/previews/h10/connectors/games_emulation_live_probe_request.v0.json', 'contracts/schema/control/previews/h10/connectors/games_emulation_live_probe_result.v0.json', 'contracts/schema/control/previews/h10/connectors/games_emulation_live_probe_output_bundle.v0.json', 'contracts/schema/control/previews/h10/connectors/games_emulation_connector_health_summary.v0.json'])
