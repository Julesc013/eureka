...
from archive.prototypes.legacy_runtime.connectors.h10_games_emulation.quality_delta import detect_h10_quality_overclaim  # noqa: E402
...
PYTHON_SCAN_PATHS = (
    "archive/prototypes/legacy_runtime/connectors/h10_games_emulation/review_integration.py",
    "archive/prototypes/legacy_runtime/connectors/h10_games_emulation/quality_delta.py",
    "archive/prototypes/legacy_runtime/connectors/h10_games_emulation/wave_postmortem.py",
...
def validate_scripts(root: Path, errors: list[str]) -> None:
    ...
    forbidden_checks = [
        ...
        [sys.executable, "scripts/summarize_h10_games_emulation_quality_delta.py", "--input-dir", "examples/connectors/h10_games_emulation/review_integration", "--output", "site/dist/data/public_index/h10.json"],
