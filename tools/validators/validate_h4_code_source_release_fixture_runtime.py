...
from archive.prototypes.legacy_runtime.connectors.h4_code_source_release.fixture_loader import load_h4_code_source_fixture  # noqa: E402
from archive.prototypes.legacy_runtime.connectors.h4_code_source_release.normalizer_common import (  # noqa: E402
    H4_FIXTURE_KINDS,
    H4_SOURCE_IDS,
...
CONTRACT_FILES = ('contracts/control_schemas/fixtures/h4/connectors/code_source_fixture.v0.json', 'contracts/control_schemas/previews/h4/connectors/code_source_normalized_record.v0.json', 'contracts/control_schemas/previews/h4/connectors/source_identity_candidate.v0.json', 'contracts/control_schemas/previews/h4/connectors/release_identity_candidate.v0.json', 'contracts/control_schemas/previews/h4/connectors/source_to_binary_relation_candidate.v0.json', 'contracts/control_schemas/previews/h4/connectors/release_asset_candidate.v0.json', 'contracts/control_schemas/fixtures/h4/connectors/code_source_fixture_replay_result.v0.json')
...
def validate_repo(root: Path = REPO_ROOT) -> dict[str, Any]:
    ...
    for source_id in H4_SOURCE_IDS:
        ...
        required_paths.append(f"archive/prototypes/legacy_runtime/connectors/h4_code_source_release/{source_id}.py")
    required_paths.extend([
        "archive/prototypes/legacy_runtime/connectors/h4_code_source_release/__init__.py",
        "archive/prototypes/legacy_runtime/connectors/h4_code_source_release/fixture_loader.py",
        "archive/prototypes/legacy_runtime/connectors/h4_code_source_release/normalizer_common.py",
        "archive/prototypes/legacy_runtime/connectors/h4_code_source_release/source_identity.py",
        "archive/prototypes/legacy_runtime/connectors/h4_code_source_release/release_identity.py",
        "archive/prototypes/legacy_runtime/connectors/h4_code_source_release/source_to_binary_relation.py",
    ])
...
def validate_fixtures(root: Path, errors: list[str]) -> None:
    for source_id in H4_SOURCE_IDS:
        normalizer = importlib.import_module(f"archive.prototypes.legacy_runtime.connectors.h4_code_source_release.{source_id}").normalize
        for kind in H4_FIXTURE_KINDS:
            filename = "policy_blocked_record.json" if kind == "policy_blocked" else f"{kind}_record.json"
...
def validate_runtime_imports(errors: list[str]) -> None:
    modules = [
        "archive.prototypes.legacy_runtime.connectors.h4_code_source_release.fixture_loader",
        "archive.prototypes.legacy_runtime.connectors.h4_code_source_release.normalizer_common",
        "archive.prototypes.legacy_runtime.connectors.h4_code_source_release.source_identity",
        "archive.prototypes.legacy_runtime.connectors.h4_code_source_release.release_identity",
        "archive.prototypes.legacy_runtime.connectors.h4_code_source_release.source_to_binary_relation",
    ] + [f"archive.prototypes.legacy_runtime.connectors.h4_code_source_release.{source_id}" for source_id in H4_SOURCE_IDS]
...
def validate_python_safety(root: Path, errors: list[str]) -> None:
    ...
    python_paths.extend((root / "archive/prototypes/legacy_runtime/connectors/h4_code_source_release").glob("*.py"))
