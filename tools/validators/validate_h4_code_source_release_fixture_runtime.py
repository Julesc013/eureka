...
CONTRACT_FILES = ('contracts/schema/control/fixtures/h4/connectors/code_source_fixture.v0.json', 'contracts/schema/control/previews/h4/connectors/code_source_normalized_record.v0.json', 'contracts/schema/control/previews/h4/connectors/source_identity_candidate.v0.json', 'contracts/schema/control/previews/h4/connectors/release_identity_candidate.v0.json', 'contracts/schema/control/previews/h4/connectors/source_to_binary_relation_candidate.v0.json', 'contracts/schema/control/previews/h4/connectors/release_asset_candidate.v0.json', 'contracts/schema/control/fixtures/h4/connectors/code_source_fixture_replay_result.v0.json')
