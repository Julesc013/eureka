...
from archive.prototypes.legacy_runtime.connectors.h6_web_archive_news_event.live_probe_common import (  # noqa: E402
    H6_SOURCE_IDS,
...
CONTRACTS = ('contracts/control_schemas/previews/h6/connectors/web_archive_live_probe_request.v0.json',
 'contracts/control_schemas/previews/h6/connectors/web_archive_live_probe_result.v0.json',
 'contracts/control_schemas/previews/h6/connectors/web_archive_live_probe_output_bundle.v0.json',
 'contracts/control_schemas/previews/h6/connectors/web_archive_connector_health_summary.v0.json')
...
PYTHON_FILES = tuple(
    ["archive/prototypes/legacy_runtime/connectors/h6_web_archive_news_event/live_probe_common.py"]
    + [f"archive/prototypes/legacy_runtime/connectors/h6_web_archive_news_event/live_probe_{source_id}.py" for source_id in EXPECTED_SOURCES]
    + [
...
def validate_runtime_imports(errors: list[str]) -> None:
    for source_id in EXPECTED_SOURCES:
        importlib.import_module(f"archive.prototypes.legacy_runtime.connectors.h6_web_archive_news_event.live_probe_{source_id}")
    importlib.import_module("archive.prototypes.legacy_runtime.connectors.h6_web_archive_news_event.live_probe_common")
