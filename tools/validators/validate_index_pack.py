...
DEFAULT_PACK_ROOT = REPO_ROOT / "examples" / "packs" / "index" / "minimal_index_pack_v0"
INDEX_PACK_SCHEMA = REPO_ROOT / "contracts" / "schema" / "control" / "policies" / "packs" / "index_pack.v0.json"
