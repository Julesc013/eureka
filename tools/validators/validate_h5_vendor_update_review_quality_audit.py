...
from archive.prototypes.legacy_runtime.connectors.h5_vendor_update_driver.quality_delta import detect_h5_quality_overclaim  # noqa: E402
...
PYTHON_SCAN_PATHS = (
    "archive/prototypes/legacy_runtime/connectors/h5_vendor_update_driver/review_integration.py",
    "archive/prototypes/legacy_runtime/connectors/h5_vendor_update_driver/quality_delta.py",
    "archive/prototypes/legacy_runtime/connectors/h5_vendor_update_driver/wave_postmortem.py",
...
def validate_scripts(root: Path, errors: list[str]) -> None:
    ...
    forbidden_commands = [
        ...
        ["python", "scripts/summarize_h5_vendor_update_quality_delta.py", "--input-dir", "examples/connectors/h5_vendor_update_driver/review_integration", "--output", "site/dist/data/public_index/h5.json", "--json"],
