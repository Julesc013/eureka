...
CONTRACTS = ('contracts/schema/control/previews/h8/connectors/manuals_docs_live_probe_request.v0.json', 'contracts/schema/control/previews/h8/connectors/manuals_docs_live_probe_result.v0.json', 'contracts/schema/control/previews/h8/connectors/manuals_docs_live_probe_output_bundle.v0.json', 'contracts/schema/control/previews/h8/connectors/manuals_docs_connector_health_summary.v0.json')
