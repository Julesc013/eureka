...
CONTRACTS = ('contracts/control_schemas/previews/h8/connectors/manuals_docs_live_probe_request.v0.json', 'contracts/control_schemas/previews/h8/connectors/manuals_docs_live_probe_result.v0.json', 'contracts/control_schemas/previews/h8/connectors/manuals_docs_live_probe_output_bundle.v0.json', 'contracts/control_schemas/previews/h8/connectors/manuals_docs_connector_health_summary.v0.json')
...
PYTHON_FILES = tuple(
    ["archive/prototypes/legacy_runtime/connectors/h8_manuals_docs_standards/live_probe_common.py"]
    + [f"archive/prototypes/legacy_runtime/connectors/h8_manuals_docs_standards/live_probe_{source_id}.py" for source_id in EXPECTED_SOURCES]
    + [
...
def validate_runtime_imports(errors: list[str]) -> None:
    try:
        importlib.import_module("archive.prototypes.legacy_runtime.connectors.h8_manuals_docs_standards.live_probe_common")
        for source_id in EXPECTED_SOURCES:
            importlib.import_module(f"archive.prototypes.legacy_runtime.connectors.h8_manuals_docs_standards.live_probe_{source_id}")
