...
PUBLIC_INDEX_STATS = REPO_ROOT / "site" / "dist" / "data" / "public_index" / "index_stats.json"
...
def _validate_public_index_summary(summary: Any, stats: Any, errors: list[str]) -> None:
    ...
    if not isinstance(stats, Mapping):
        errors.append("site/dist/data/public_index/index_stats.json must be an object.")
        return
    ...
    if summary.get("artifact_root") != "site/dist/data/public_index":
        errors.append("data/public_index_summary.json artifact_root must be site/dist/data/public_index.")
