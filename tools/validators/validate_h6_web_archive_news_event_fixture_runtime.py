...
CONTRACT_FILES = ('contracts/schema/control/fixtures/h6/connectors/web_archive_fixture.v0.json', 'contracts/schema/control/previews/h6/connectors/web_archive_normalized_record.v0.json', 'contracts/schema/control/previews/h6/connectors/web_capture_identity_candidate.v0.json', 'contracts/schema/control/previews/h6/connectors/archived_url_time_state_candidate.v0.json', 'contracts/schema/control/previews/h6/connectors/news_event_mention_candidate.v0.json', 'contracts/schema/control/previews/h6/connectors/dead_link_trace_candidate.v0.json', 'contracts/schema/control/previews/h6/connectors/public_document_trace_candidate.v0.json', 'contracts/schema/control/previews/h6/connectors/media_transcript_metadata_candidate.v0.json', 'contracts/schema/control/fixtures/h6/connectors/web_archive_fixture_replay_result.v0.json')
