...
from archive.prototypes.legacy_runtime.connectors.h6_web_archive_news_event.normalizer_common import (  # noqa: E402
    H6_FIXTURE_KINDS,
    H6_SOURCE_IDS,
...
CONTRACT_FILES = ('contracts/control_schemas/fixtures/h6/connectors/web_archive_fixture.v0.json', 'contracts/control_schemas/previews/h6/connectors/web_archive_normalized_record.v0.json', 'contracts/control_schemas/previews/h6/connectors/web_capture_identity_candidate.v0.json', 'contracts/control_schemas/previews/h6/connectors/archived_url_time_state_candidate.v0.json', 'contracts/control_schemas/previews/h6/connectors/news_event_mention_candidate.v0.json', 'contracts/control_schemas/previews/h6/connectors/dead_link_trace_candidate.v0.json', 'contracts/control_schemas/previews/h6/connectors/public_document_trace_candidate.v0.json', 'contracts/control_schemas/previews/h6/connectors/media_transcript_metadata_candidate.v0.json', 'contracts/control_schemas/fixtures/h6/connectors/web_archive_fixture_replay_result.v0.json')
...
def validate_repo(root: Path = REPO_ROOT) -> dict[str, Any]:
    ...
    for source_id in H6_SOURCE_IDS:
        ...
        required_paths.append(f"archive/prototypes/legacy_runtime/connectors/h6_web_archive_news_event/{source_id}.py")
    required_paths.extend([
        "archive/prototypes/legacy_runtime/connectors/h6_web_archive_news_event/__init__.py",
        "archive/prototypes/legacy_runtime/connectors/h6_web_archive_news_event/fixture_loader.py",
        "archive/prototypes/legacy_runtime/connectors/h6_web_archive_news_event/normalizer_common.py",
        "archive/prototypes/legacy_runtime/connectors/h6_web_archive_news_event/web_capture_identity.py",
        "archive/prototypes/legacy_runtime/connectors/h6_web_archive_news_event/archived_url_time_state.py",
        "archive/prototypes/legacy_runtime/connectors/h6_web_archive_news_event/news_event_mention.py",
        "archive/prototypes/legacy_runtime/connectors/h6_web_archive_news_event/dead_link_trace.py",
        "archive/prototypes/legacy_runtime/connectors/h6_web_archive_news_event/public_document_trace.py",
        "archive/prototypes/legacy_runtime/connectors/h6_web_archive_news_event/media_transcript_metadata.py",
    ])
...
def validate_fixtures(root: Path, errors: list[str]) -> None:
    for source_id in H6_SOURCE_IDS:
        normalizer = importlib.import_module(f"archive.prototypes.legacy_runtime.connectors.h6_web_archive_news_event.{source_id}").normalize
        for kind in H6_FIXTURE_KINDS:
            filename = "policy_blocked_record.json" if kind == "policy_blocked" else f"{kind}_record.json"
...
def validate_runtime_imports(errors: list[str]) -> None:
    for source_id in H6_SOURCE_IDS:
        importlib.import_module(f"archive.prototypes.legacy_runtime.connectors.h6_web_archive_news_event.{source_id}")
    for module in ("fixture_loader", "normalizer_common", "web_capture_identity", "archived_url_time_state", "news_event_mention", "dead_link_trace", "public_document_trace", "media_transcript_metadata"):
        importlib.import_module(f"archive.prototypes.legacy_runtime.connectors.h6_web_archive_news_event.{module}")


def validate_python_safety(root: Path, errors: list[str]) -> None:
    runtime_dir = root / "archive/prototypes/legacy_runtime/connectors/h6_web_archive_news_event"
