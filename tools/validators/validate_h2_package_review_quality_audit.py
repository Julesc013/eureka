...
from archive.prototypes.legacy_runtime.connectors.h2_package_registries.quality_delta import detect_h2_quality_overclaim  # noqa: E402
...
REQUIRED_JSON = (
    "contracts/control_schemas/audits/h2/connectors/package_review_integration_result.v0.json",
    "contracts/control_schemas/audits/h2/connectors/package_quality_delta_report.v0.json",
    "contracts/control_schemas/audits/h2/connectors/package_connector_wave_postmortem.v0.json",
    "contracts/control_schemas/audits/h2/connectors/package_integration_audit.v0.json",
    "contracts/control_schemas/tasks/h2/connectors/package_next_phase_recommendation.v0.json",
...
PYTHON_SCAN_PATHS = (
    "archive/prototypes/legacy_runtime/connectors/h2_package_registries/review_integration.py",
    "archive/prototypes/legacy_runtime/connectors/h2_package_registries/quality_delta.py",
    "archive/prototypes/legacy_runtime/connectors/h2_package_registries/wave_postmortem.py",
...
def validate_scripts(root: Path, errors: list[str]) -> None:
    ...
    bad_public = subprocess.run(
        [sys.executable, "scripts/summarize_h2_package_quality_delta.py", "--input-dir", "examples/connectors/h2_package_registries/review_integration", "--output", "site/dist/data/public_index/h2-quality.json"],
        cwd=root,
        check=False,
        capture_output=True,
        text=True,
