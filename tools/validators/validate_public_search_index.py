...
DEFAULT_INDEX_ROOT = REPO_ROOT / "site" / "dist" / "data" / "public_index"
...
def _validate_manifest(payload: Any, errors: list[str]) -> None:
    ...
    if payload.get("artifact_root") != "site/dist/data/public_index":
        errors.append("build_manifest.json: artifact_root must be site/dist/data/public_index.")
