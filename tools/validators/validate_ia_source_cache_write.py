...
REQUIRED_FILES = (
    ...
    "examples/sources/cache/dry_run/internet_archive_metadata/expected_source_cache_records.json",
    "examples/sources/cache/dry_run/internet_archive_metadata/expected_source_cache_boundary_report.json",
