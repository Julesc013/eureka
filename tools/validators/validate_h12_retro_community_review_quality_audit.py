...
from archive.prototypes.legacy_runtime.connectors.h12_retro_community.quality_delta import detect_h12_quality_overclaim  # noqa: E402
...
PYTHON_SCAN_PATHS = (
    "archive/prototypes/legacy_runtime/connectors/h12_retro_community/review_integration.py",
    "archive/prototypes/legacy_runtime/connectors/h12_retro_community/quality_delta.py",
    "archive/prototypes/legacy_runtime/connectors/h12_retro_community/wave_postmortem.py",
...
def validate_scripts(root: Path, errors: list[str]) -> None:
    ...
    forbidden_checks = [
        ...
        [sys.executable, "scripts/summarize_h12_retro_community_quality_delta.py", "--input-dir", "examples/connectors/h12_retro_community/review_integration", "--output", "site/dist/data/public_index/h12.json"],
