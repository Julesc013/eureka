...
from archive.prototypes.legacy_runtime.connectors.h5_vendor_update_driver.fixture_loader import load_h5_vendor_update_fixture  # noqa: E402
from archive.prototypes.legacy_runtime.connectors.h5_vendor_update_driver.normalizer_common import (  # noqa: E402
    H5_FIXTURE_KINDS,
    H5_SOURCE_IDS,
...
CONTRACT_FILES = (
    "contracts/control_schemas/fixtures/h5/connectors/vendor_update_fixture.v0.json",
    "contracts/control_schemas/previews/h5/connectors/vendor_update_normalized_record.v0.json",
    "contracts/control_schemas/previews/h5/connectors/vendor_identity_candidate.v0.json",
    "contracts/control_schemas/previews/h5/connectors/driver_device_compatibility_candidate.v0.json",
    "contracts/control_schemas/previews/h5/connectors/firmware_update_candidate.v0.json",
    "contracts/control_schemas/previews/h5/connectors/runtime_redistributable_candidate.v0.json",
    "contracts/control_schemas/previews/h5/connectors/vendor_payload_metadata_candidate.v0.json",
    "contracts/control_schemas/fixtures/h5/connectors/vendor_update_fixture_replay_result.v0.json",
)
POLICY_FILES = (
...
def validate_repo(root: Path = REPO_ROOT) -> dict[str, Any]:
    ...
    for source_id in H5_SOURCE_IDS:
        ...
        required_paths.append(f"archive/prototypes/legacy_runtime/connectors/h5_vendor_update_driver/{source_id}.py")
    required_paths.extend([
        "archive/prototypes/legacy_runtime/connectors/h5_vendor_update_driver/__init__.py",
        "archive/prototypes/legacy_runtime/connectors/h5_vendor_update_driver/fixture_loader.py",
        "archive/prototypes/legacy_runtime/connectors/h5_vendor_update_driver/normalizer_common.py",
        "archive/prototypes/legacy_runtime/connectors/h5_vendor_update_driver/vendor_identity.py",
        "archive/prototypes/legacy_runtime/connectors/h5_vendor_update_driver/driver_device_compatibility.py",
        "archive/prototypes/legacy_runtime/connectors/h5_vendor_update_driver/firmware_update.py",
        "archive/prototypes/legacy_runtime/connectors/h5_vendor_update_driver/runtime_redistributable.py",
        "archive/prototypes/legacy_runtime/connectors/h5_vendor_update_driver/payload_metadata.py",
    ])
...
def validate_fixtures(root: Path, errors: list[str]) -> None:
    for source_id in H5_SOURCE_IDS:
        normalizer = importlib.import_module(f"archive.prototypes.legacy_runtime.connectors.h5_vendor_update_driver.{source_id}").normalize
        for kind in H5_FIXTURE_KINDS:
            filename = "policy_blocked_record.json" if kind == "policy_blocked" else f"{kind}_record.json"
...
def validate_runtime_imports(errors: list[str]) -> None:
    modules = [
        "archive.prototypes.legacy_runtime.connectors.h5_vendor_update_driver.fixture_loader",
        "archive.prototypes.legacy_runtime.connectors.h5_vendor_update_driver.normalizer_common",
        "archive.prototypes.legacy_runtime.connectors.h5_vendor_update_driver.vendor_identity",
        "archive.prototypes.legacy_runtime.connectors.h5_vendor_update_driver.driver_device_compatibility",
        "archive.prototypes.legacy_runtime.connectors.h5_vendor_update_driver.firmware_update",
        "archive.prototypes.legacy_runtime.connectors.h5_vendor_update_driver.runtime_redistributable",
        "archive.prototypes.legacy_runtime.connectors.h5_vendor_update_driver.payload_metadata",
    ] + [f"archive.prototypes.legacy_runtime.connectors.h5_vendor_update_driver.{source_id}" for source_id in H5_SOURCE_IDS]
...
def validate_python_safety(root: Path, errors: list[str]) -> None:
    ...
    python_paths.extend((root / "archive/prototypes/legacy_runtime/connectors/h5_vendor_update_driver").glob("*.py"))
    for path in python_paths:
        ...
        if path.as_posix().endswith("archive/prototypes/legacy_runtime/connectors/h5_vendor_update_driver/normalizer_common.py") and TOOL_COMMAND_RE.search(text):
