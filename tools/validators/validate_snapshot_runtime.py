...
CONTRACTS = [
    ...
    "contracts/schema/control/audits/snapshots/snapshot_fixity_report.v0.json",
    "contracts/snapshots/snapshot_signature_envelope.v0.json",
    "contracts/schema/control/audits/snapshots/snapshot_verification_report.v0.json",
    "contracts/schema/control/audits/snapshots/snapshot_consumer_report.v0.json",
