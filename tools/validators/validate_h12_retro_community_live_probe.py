...
CONTRACTS = tuple("contracts/schema/control/previews/h12/connectors/" + name for name in ('retro_community_live_probe_request.v0.json', 'retro_community_live_probe_result.v0.json', 'retro_community_live_probe_output_bundle.v0.json', 'retro_community_connector_health_summary.v0.json'))
