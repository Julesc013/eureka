...
from archive.prototypes.legacy_runtime.connectors.h4_code_source_release.quality_delta import detect_h4_quality_overclaim  # noqa: E402
...
REQUIRED_JSON = (
    "contracts/control_schemas/audits/h4/connectors/code_source_review_integration_result.v0.json",
    "contracts/control_schemas/audits/h4/connectors/code_source_quality_delta_report.v0.json",
    "contracts/control_schemas/audits/h4/connectors/code_source_connector_wave_postmortem.v0.json",
    "contracts/control_schemas/audits/h4/connectors/code_source_integration_audit.v0.json",
    "contracts/control_schemas/tasks/h4/connectors/code_source_next_phase_recommendation.v0.json",
...
PYTHON_SCAN_PATHS = (
    "archive/prototypes/legacy_runtime/connectors/h4_code_source_release/review_integration.py",
    "archive/prototypes/legacy_runtime/connectors/h4_code_source_release/quality_delta.py",
    "archive/prototypes/legacy_runtime/connectors/h4_code_source_release/wave_postmortem.py",
...
def validate_scripts(root: Path, errors: list[str]) -> None:
    ...
    forbidden_commands = [
        ...
        ["python", "scripts/summarize_h4_code_source_quality_delta.py", "--input-dir", "examples/connectors/h4_code_source_release/review_integration", "--output", "site/dist/data/public_index/h4.json", "--json"],
