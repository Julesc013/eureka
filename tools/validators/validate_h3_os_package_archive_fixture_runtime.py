...
from archive.prototypes.legacy_runtime.connectors.h3_os_package_archives.fixture_loader import load_h3_os_package_fixture, validate_h3_os_package_fixture  # noqa: E402
from archive.prototypes.legacy_runtime.connectors.h3_os_package_archives.normalizer_common import (  # noqa: E402
    H3_SOURCE_IDS,
...
PYTHON_FILES = (
    "archive/prototypes/legacy_runtime/connectors/h3_os_package_archives/__init__.py",
    "archive/prototypes/legacy_runtime/connectors/h3_os_package_archives/fixture_loader.py",
    "archive/prototypes/legacy_runtime/connectors/h3_os_package_archives/normalizer_common.py",
    "archive/prototypes/legacy_runtime/connectors/h3_os_package_archives/os_package_identity.py",
    "archive/prototypes/legacy_runtime/connectors/h3_os_package_archives/os_platform_compatibility.py",
    *(f"archive/prototypes/legacy_runtime/connectors/h3_os_package_archives/{source_id}.py" for source_id in H3_SOURCE_IDS),
...
def validate_script_offline_behavior(root: Path, errors: list[str]) -> None:
    ...
    bad_public = subprocess.run([sys.executable, "scripts/replay_h3_os_package_fixtures.py", "--output-dir", "site/dist/data/public_index/h3"], cwd=root, check=False, capture_output=True, text=True, timeout=120)
