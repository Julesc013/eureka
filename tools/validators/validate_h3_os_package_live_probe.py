...
CONTRACTS = (
    "contracts/control_schemas/previews/h3/connectors/os_package_live_probe_request.v0.json",
    "contracts/control_schemas/previews/h3/connectors/os_package_live_probe_result.v0.json",
    "contracts/control_schemas/previews/h3/connectors/os_package_live_probe_output_bundle.v0.json",
    "contracts/control_schemas/previews/h3/connectors/os_package_connector_health_summary.v0.json",
)
POLICIES = (
...
PYTHON_FILES = tuple(
    ["archive/prototypes/legacy_runtime/connectors/h3_os_package_archives/live_probe_common.py"]
    + [f"archive/prototypes/legacy_runtime/connectors/h3_os_package_archives/live_probe_{source_id}.py" for source_id in H3_SOURCE_IDS]
    + [
...
def validate_cli_offline(root: Path, errors: list[str]) -> None:
    ...
    for bad_path in ("site/dist/h3.json", "site/dist/data/public_index/h3.json", "repository_mirror/h3.json"):
