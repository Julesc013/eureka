...
REQUIRED_CONTRACTS = [
    "contracts/control_schemas/audits/audits/mvp_alpha_readiness_audit.v0.json",
    "contracts/control_schemas/audits/audits/mvp_alpha_gate_decision.v0.json",
    "contracts/control_schemas/audits/audits/mvp_alpha_integration_matrix.v0.json",
    "contracts/control_schemas/audits/audits/mvp_alpha_remediation_plan.v0.json",
    "contracts/control_schemas/audits/audits/mvp_alpha_operator_review_packet.v0.json",
]
REQUIRED_POLICIES = [
