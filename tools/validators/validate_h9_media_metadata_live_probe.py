...
CONTRACTS = tuple(['contracts/control_schemas/previews/h9/connectors/media_metadata_live_probe_request.v0.json', 'contracts/control_schemas/previews/h9/connectors/media_metadata_live_probe_result.v0.json', 'contracts/control_schemas/previews/h9/connectors/media_metadata_live_probe_output_bundle.v0.json', 'contracts/control_schemas/previews/h9/connectors/media_metadata_connector_health_summary.v0.json'])
...
PYTHON_FILES = tuple(
    ["archive/prototypes/legacy_runtime/connectors/h9_media_metadata/live_probe_common.py"]
    + [f"archive/prototypes/legacy_runtime/connectors/h9_media_metadata/live_probe_{source_id}.py" for source_id in EXPECTED_SOURCES]
    + [
...
def validate_runtime_imports(errors: list[str]) -> None:
    try:
        importlib.import_module("archive.prototypes.legacy_runtime.connectors.h9_media_metadata.live_probe_common")
        for source_id in EXPECTED_SOURCES:
            importlib.import_module(f"archive.prototypes.legacy_runtime.connectors.h9_media_metadata.live_probe_{source_id}")
