...
CONTRACTS = tuple(['contracts/schema/control/previews/h9/connectors/media_metadata_live_probe_request.v0.json', 'contracts/schema/control/previews/h9/connectors/media_metadata_live_probe_result.v0.json', 'contracts/schema/control/previews/h9/connectors/media_metadata_live_probe_output_bundle.v0.json', 'contracts/schema/control/previews/h9/connectors/media_metadata_connector_health_summary.v0.json'])
