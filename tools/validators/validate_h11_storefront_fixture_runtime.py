...
CONTRACTS = ['contracts/control_schemas/fixtures/h11/connectors/storefront_fixture.v0.json', 'contracts/control_schemas/previews/h11/connectors/storefront_normalized_record.v0.json', 'contracts/control_schemas/previews/h11/connectors/storefront_listing_identity_candidate.v0.json', 'contracts/control_schemas/previews/h11/connectors/app_product_identity_candidate.v0.json', 'contracts/control_schemas/previews/h11/connectors/version_release_channel_candidate.v0.json', 'contracts/control_schemas/previews/h11/connectors/price_availability_region_candidate.v0.json', 'contracts/control_schemas/previews/h11/connectors/acquisition_path_candidate.v0.json', 'contracts/control_schemas/previews/h11/connectors/review_rating_metadata_candidate.v0.json', 'contracts/control_schemas/previews/h11/connectors/account_entitlement_boundary_candidate.v0.json', 'contracts/control_schemas/previews/h11/connectors/storefront_rights_safety_candidate.v0.json', 'contracts/control_schemas/fixtures/h11/connectors/storefront_fixture_replay_result.v0.json']
