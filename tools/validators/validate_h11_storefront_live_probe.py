...
CONTRACTS = tuple("contracts/schema/control/previews/h11/connectors/" + name for name in ['storefront_live_probe_request.v0.json', 'storefront_live_probe_result.v0.json', 'storefront_live_probe_output_bundle.v0.json', 'storefront_connector_health_summary.v0.json'])
