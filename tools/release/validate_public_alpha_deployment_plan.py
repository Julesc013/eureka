...
REQUIRED_CONTRACTS = [
    "contracts/control_schemas/policies/hosting/public_alpha_deployment_plan.v0.json",
    "contracts/control_schemas/policies/hosting/public_alpha_deployment_step.v0.json",
    "contracts/control_schemas/policies/hosting/public_alpha_environment_matrix.v0.json",
    "contracts/hosting/public_alpha_config_manifest.v0.json",
    "contracts/control_schemas/policies/hosting/public_alpha_static_backend_split.v0.json",
    "contracts/control_schemas/policies/hosting/public_alpha_dns_readiness.v0.json",
    "contracts/hosting/public_alpha_provider_profile.v0.json",
    "contracts/control_schemas/policies/hosting/public_alpha_rollout_gate.v0.json",
    "contracts/control_schemas/policies/hosting/public_alpha_operator_checklist.v0.json",
    "contracts/control_schemas/audits/hosting/public_alpha_deployment_noop_report.v0.json",
]
REQUIRED_POLICIES = [
