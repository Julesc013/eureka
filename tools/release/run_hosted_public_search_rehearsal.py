...
def _check_public_index() -> list[dict[str, Any]]:
    root = REPO_ROOT / "site" / "dist" / "data" / "public_index"
    ...
    return [
        {
            "artifact_root": "site/dist/data/public_index",
...
def _public_index_document_count() -> int:
    stats = _load_json(REPO_ROOT / "site" / "dist" / "data" / "public_index" / "index_stats.json")
