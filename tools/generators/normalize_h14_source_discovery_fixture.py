...
from archive.prototypes.legacy_runtime.connectors.h14_source_discovery.normalizer_common import H14_SOURCE_IDS  # noqa: E402
...
FORBIDDEN_PREFIXES = (
    "site/dist", "site/dist/data/public_index", "runtime", "contracts", "control/inventory/sources", "control/inventory/connectors",
...
def main(argv: Sequence[str] | None = None, stdout: TextIO = sys.stdout) -> int:
    ...
    try:
        ...
        module = importlib.import_module(f"archive.prototypes.legacy_runtime.connectors.h14_source_discovery.{SOURCE_MODULES[args.source_id]}")
