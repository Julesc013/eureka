...
def _build_public_index_summary() -> dict[str, Any]:
    ...
    generated_files = [
        f"site/dist/data/public_index/{name}"
    ...
    return {
        ...
        "artifact_root": manifest.get("artifact_root", "site/dist/data/public_index"),
        ...
        "index_stats_ref": "site/dist/data/public_index/index_stats.json",
