...
from archive.prototypes.legacy_runtime.connectors.h9_media_metadata.normalizer_common import H9_SOURCE_IDS, build_h9_fixture_replay_result  # noqa: E402
...
def replay_fixtures(fixture_root: str | Path, source_id: str | None = None) -> list[dict[str, Any]]:
    ...
    for item in ([source_id] if source_id else list(H9_SOURCE_IDS)):
        ...
        module = importlib.import_module(f"archive.prototypes.legacy_runtime.connectors.h9_media_metadata.{item}")
