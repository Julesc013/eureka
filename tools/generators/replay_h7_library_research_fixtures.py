...
from archive.prototypes.legacy_runtime.connectors.h7_library_research.normalizer_common import H7_SOURCE_IDS, build_h7_fixture_replay_result  # noqa: E402
...
def replay_fixtures(fixture_root: str | Path, source_id: str | None = None) -> list[dict[str, Any]]:
    ...
    for item in ([source_id] if source_id else list(H7_SOURCE_IDS)):
        ...
        module = importlib.import_module(f"archive.prototypes.legacy_runtime.connectors.h7_library_research.{item}")
