...
def build_dry_run_cache_entry(query: str) -> dict[str, Any]:
    ...
    return {
        ...
        "checked_scope": {
            ...
            "checked_sources": [] if unsafe else ["site/dist/data/public_index"],
            "live_probes_attempted": False,
            "external_calls_performed": False,
        },
        "index_refs": {
            "public_index_build_id": INDEX_SNAPSHOT_REF,
            "public_index_manifest_ref": "site/dist/data/public_index/build_manifest.json",
            "source_coverage_ref": "site/dist/data/public_index/source_coverage.json",
        ...
        "freshness": {
            ...
            "index_snapshot_ref": INDEX_SNAPSHOT_REF,
            "build_manifest_ref": "site/dist/data/public_index/build_manifest.json",
...
def _absence_summary(*, unsafe: bool, no_hit: bool) -> dict[str, Any]:
    ...
    if no_hit:
        return {
            ...
            "checked": ["site/dist/data/public_index"],
