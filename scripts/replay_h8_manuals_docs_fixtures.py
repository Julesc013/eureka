...
from runtime.connectors.h8_manuals_docs_standards.normalizer_common import H8_SOURCE_IDS, build_h8_fixture_replay_result  # noqa: E402
...
def replay_fixtures(fixture_root: str | Path, source_id: str | None = None) -> list[dict[str, Any]]:
    ...
    for item in ([source_id] if source_id else list(H8_SOURCE_IDS)):
        ...
        module = importlib.import_module(f"runtime.connectors.h8_manuals_docs_standards.{item}")
