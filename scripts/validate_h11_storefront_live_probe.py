...
CONTRACTS = tuple("contracts/connectors/" + name for name in ['h11_storefront_live_probe_request.v0.json', 'h11_storefront_live_probe_result.v0.json', 'h11_storefront_live_probe_output_bundle.v0.json', 'h11_storefront_connector_health_summary.v0.json'])
