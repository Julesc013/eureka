...
CONTRACT_FILES = ('contracts/connectors/h6_web_archive_fixture.v0.json', 'contracts/connectors/h6_web_archive_normalized_record.v0.json', 'contracts/connectors/h6_web_capture_identity_candidate.v0.json', 'contracts/connectors/h6_archived_url_time_state_candidate.v0.json', 'contracts/connectors/h6_news_event_mention_candidate.v0.json', 'contracts/connectors/h6_dead_link_trace_candidate.v0.json', 'contracts/connectors/h6_public_document_trace_candidate.v0.json', 'contracts/connectors/h6_media_transcript_metadata_candidate.v0.json', 'contracts/connectors/h6_web_archive_fixture_replay_result.v0.json')
