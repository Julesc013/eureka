...
def validate_script_offline_behavior(root: Path, errors: list[str]) -> None:
    ...
    bad_public = subprocess.run([sys.executable, "scripts/replay_h2_package_fixtures.py", "--output-dir", "data/public_index/h2"], cwd=root, check=False, capture_output=True, text=True, timeout=120)
