...
REQUIRED_JSON = (
    "control/schemas/audits/h9/connectors/media_metadata_review_integration_result.v0.json",
    "control/schemas/audits/h9/connectors/media_metadata_quality_delta_report.v0.json",
    "control/schemas/audits/h9/connectors/media_metadata_connector_wave_postmortem.v0.json",
    "control/schemas/audits/h9/connectors/media_metadata_integration_audit.v0.json",
    "control/schemas/tasks/h9/connectors/media_metadata_next_phase_recommendation.v0.json",
...
def validate_scripts(root: Path, errors: list[str]) -> None:
    ...
    forbidden_checks = [
        ...
        [sys.executable, "scripts/summarize_h9_media_metadata_quality_delta.py", "--input-dir", "examples/connectors/h9_media_metadata/review_integration", "--output", "data/public_index/h9.json"],
