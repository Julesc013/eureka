...
from control.prototypes.legacy_runtime.connectors.h3_os_package_archives.quality_delta import detect_h3_quality_overclaim  # noqa: E402
...
PYTHON_SCAN_PATHS = (
    "control/prototypes/legacy_runtime/connectors/h3_os_package_archives/review_integration.py",
    "control/prototypes/legacy_runtime/connectors/h3_os_package_archives/quality_delta.py",
    "control/prototypes/legacy_runtime/connectors/h3_os_package_archives/wave_postmortem.py",
...
def validate_scripts(root: Path, errors: list[str]) -> None:
    ...
    bad_public = subprocess.run(
        [sys.executable, "scripts/summarize_h3_os_package_quality_delta.py", "--input-dir", "examples/connectors/h3_os_package_archives/review_integration", "--output", "data/public_index/h3-quality.json"],
        cwd=root,
        check=False,
        capture_output=True,
        text=True,
