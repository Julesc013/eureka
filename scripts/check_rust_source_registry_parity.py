...
# --require-cargo; skipped_cargo_unavailable; runtime_wiring_allowed
...
_TARGET = Path(__file__).resolve().parents[1] / 'tools/validators/check_rust_source_registry_parity.py'
