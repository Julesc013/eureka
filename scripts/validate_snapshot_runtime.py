...
CONTRACTS = [
    ...
    "control/schemas/audits/snapshots/snapshot_fixity_report.v0.json",
    "contracts/snapshots/snapshot_signature_envelope.v0.json",
    "control/schemas/audits/snapshots/snapshot_verification_report.v0.json",
    "control/schemas/audits/snapshots/snapshot_consumer_report.v0.json",
...
def _assert_forbidden_outputs_rejected(policy: Mapping[str, Any]) -> None:
    for rel in ("site/dist/snapshot.txt", "data/public_index/snapshot.json", "runtime/snapshots/generated.json"):
        try:
