#!/usr/bin/env python3
"""Run the fixture-first driver/support-media seed batch."""
...
from runtime.seed_batches import run_seed_batch_driver_support  # noqa: E402
...
def main(argv: Sequence[str] | None = None, stdout: TextIO = sys.stdout) -> int:
    ...
    mode.add_argument(
        ...
        action="store_true",
        help="Build bounded archive.org metadata dry-run posture without live calls.",
    )
