...
TARGET_ROOTS = {
    ...
    "control_schema": "control/schemas/policies/",
    "audit_schema": "control/schemas/audits/",
    "fixture_schema": "control/schemas/fixtures/",
    "preview_schema": "control/schemas/previews/",
    "validator_schema": "control/schemas/validators/",
    "task_queue_schema": "control/schemas/tasks/",
    "generated_scaffold_schema": "control/schemas/deprecated/",
    "deprecated_schema": "control/schemas/deprecated/",
    "unknown": "control/schemas/deprecated/",
}
...
def rationale_for(item: Mapping[str, Any], action: str) -> str:
    ...
    if action == "move_and_rename":
        return "Artifact belongs under control/schemas and should drop task-phase prefix from the filename."
    if action == "move":
...
def build_execution_plan(migration_plan: Mapping[str, Any], reference_graph: Mapping[str, Any]) -> dict[str, Any]:
    ...
    batches = [
        {
            "batch_id": "R0-03B-1",
            "purpose": "Create control/schemas target roots and move audit, fixture, preview, task, validator, deprecated, and generated scaffold schemas.",
            "moves": [move for move in moves if str(move["target_path"]).startswith("control/schemas/")],
            "reference_updates": [],
            "validation_commands": [
