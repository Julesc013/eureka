...
PYTHON_FILES = tuple(
    ["control/prototypes/legacy_runtime/connectors/h7_library_research/live_probe_common.py"]
    + [f"control/prototypes/legacy_runtime/connectors/h7_library_research/live_probe_{source_id}.py" for source_id in EXPECTED_SOURCES]
    + [
...
def validate_runtime_imports(errors: list[str]) -> None:
    try:
        importlib.import_module("control.prototypes.legacy_runtime.connectors.h7_library_research.live_probe_common")
        for source_id in EXPECTED_SOURCES:
            importlib.import_module(f"control.prototypes.legacy_runtime.connectors.h7_library_research.live_probe_{source_id}")
