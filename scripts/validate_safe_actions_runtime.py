...
CONTRACTS = (
    ...
    "contracts/actions/action_result_preview.v0.json",
    ...
    "contracts/actions/blocked_action_report.v0.json",
...
def validate_scripts(root: Path, errors: list[str]) -> None:
    ...
    for script, base_args in forbidden_outputs:
        for output in ("site/dist/action.json", "data/public_index/action.json", "download/action.json", "runtime/action.json"):
