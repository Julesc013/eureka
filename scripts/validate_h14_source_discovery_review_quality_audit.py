...
REQUIRED_JSON = (
    ...
    "control/schemas/tasks/h14/connectors/source_discovery_next_phase_recommendation.v0.json",
...
def validate_scripts(root: Path, errors: list[str]) -> None:
    ...
    forbidden_checks = [
        ...
        [sys.executable, "scripts/summarize_h14_source_discovery_quality_delta.py", "--input-dir", "examples/connectors/h14_source_discovery/review_integration", "--output", "data/public_index/h14.json"],
