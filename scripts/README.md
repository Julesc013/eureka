...
Deterministic tests and demo flows now cover a bounded mixed corpus composed from governed synthetic fixtures plus small recorded GitHub Releases fixtures. They also surface the first bounded evidence-summary seam and the first bounded comparison/disagreement seam without implying a final provenance, trust, merge, or truth-selection architecture. Live GitHub acquisition remains intentionally deferred.
