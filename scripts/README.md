...
- `demo_web_workbench.py`: renders the compatibility-first web workbench or deterministic search page either once to stdout, starts a tiny stdlib local server, or exports a bounded resolution manifest as JSON
