...
CONTRACTS = ('contracts/connectors/h8_manuals_docs_live_probe_request.v0.json', 'contracts/connectors/h8_manuals_docs_live_probe_result.v0.json', 'contracts/connectors/h8_manuals_docs_live_probe_output_bundle.v0.json', 'contracts/connectors/h8_manuals_docs_connector_health_summary.v0.json')
