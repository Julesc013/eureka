...
CONTRACTS = [
    ...
    "control/schemas/fixtures/relay/native_fixture_endpoint.v0.json",
]
POLICIES = [
...
def _assert_forbidden_outputs_rejected(policy: Mapping[str, Any]) -> None:
    for rel in ("site/dist/relay.html", "data/public_index/relay.json", "runtime/relay/generated.json", "contracts/relay/generated.json"):
        try:
