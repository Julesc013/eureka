...
from control.prototypes.legacy_runtime.connectors.h2_package_registries.quality_delta import detect_h2_quality_overclaim  # noqa: E402
...
REQUIRED_JSON = (
    "control/schemas/audits/h2/connectors/package_review_integration_result.v0.json",
    "control/schemas/audits/h2/connectors/package_quality_delta_report.v0.json",
    "control/schemas/audits/h2/connectors/package_connector_wave_postmortem.v0.json",
    "control/schemas/audits/h2/connectors/package_integration_audit.v0.json",
    "control/schemas/tasks/h2/connectors/package_next_phase_recommendation.v0.json",
...
PYTHON_SCAN_PATHS = (
    "control/prototypes/legacy_runtime/connectors/h2_package_registries/review_integration.py",
    "control/prototypes/legacy_runtime/connectors/h2_package_registries/quality_delta.py",
    "control/prototypes/legacy_runtime/connectors/h2_package_registries/wave_postmortem.py",
