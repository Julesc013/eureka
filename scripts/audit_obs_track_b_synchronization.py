...
TRACK_B_CONTRACT_PATHS = (
    ...
    "control/schemas/policies/node/node_capability.v0.json",
    "control/schemas/policies/node/work_unit.v0.json",
    "control/schemas/policies/node/work_unit_result.v0.json",
...
def detect_track_b_state(repo_root: Path = REPO_ROOT) -> dict[str, Any]:
    ...
    return {
        ...
        "contracts_present": {
            ...
            "node_capability": (repo_root / "control/schemas/policies/node/node_capability.v0.json").is_file(),
            "workunit_contract": (repo_root / "control/schemas/policies/node/work_unit.v0.json").is_file(),
            "workunit_result_contract": (repo_root / "control/schemas/policies/node/work_unit_result.v0.json").is_file(),
            "local_foundry_state_contract": (repo_root / "control/schemas/policies/node/local_foundry_state.v0.json").is_file()
        },
