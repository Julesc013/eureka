...
from control.prototypes.legacy_runtime.connectors.h11_storefront.normalizer_common import H11_FIXTURE_KINDS, H11_SOURCE_IDS, detect_h11_product_boundary_violations, detect_h11_truth_boundary_violations  # noqa: E402

CONTRACTS = ['control/schemas/fixtures/h11/connectors/storefront_fixture.v0.json', 'control/schemas/previews/h11/connectors/storefront_normalized_record.v0.json', 'control/schemas/previews/h11/connectors/storefront_listing_identity_candidate.v0.json', 'control/schemas/previews/h11/connectors/app_product_identity_candidate.v0.json', 'control/schemas/previews/h11/connectors/version_release_channel_candidate.v0.json', 'control/schemas/previews/h11/connectors/price_availability_region_candidate.v0.json', 'control/schemas/previews/h11/connectors/acquisition_path_candidate.v0.json', 'control/schemas/previews/h11/connectors/review_rating_metadata_candidate.v0.json', 'control/schemas/previews/h11/connectors/account_entitlement_boundary_candidate.v0.json', 'control/schemas/previews/h11/connectors/storefront_rights_safety_candidate.v0.json', 'control/schemas/fixtures/h11/connectors/storefront_fixture_replay_result.v0.json']
...
RUNTIME_DIR = "control/prototypes/legacy_runtime/connectors/h11_storefront"
...
def _check_forbidden_output_roots(root: Path, errors: list[str]) -> None:
    checks = [
        ...
        [sys.executable, "scripts/normalize_h11_storefront_fixture.py", "--source-id", "fdroid_metadata", "--input", "examples/connectors/h11_storefront/fixtures/fdroid_metadata/minimal_record.json", "--output", "data/public_index/h11.json"],
