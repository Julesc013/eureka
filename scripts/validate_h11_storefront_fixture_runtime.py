...
CONTRACTS = ['contracts/connectors/h11_storefront_fixture.v0.json', 'contracts/connectors/h11_storefront_normalized_record.v0.json', 'contracts/connectors/h11_storefront_listing_identity_candidate.v0.json', 'contracts/connectors/h11_app_product_identity_candidate.v0.json', 'contracts/connectors/h11_version_release_channel_candidate.v0.json', 'contracts/connectors/h11_price_availability_region_candidate.v0.json', 'contracts/connectors/h11_acquisition_path_candidate.v0.json', 'contracts/connectors/h11_review_rating_metadata_candidate.v0.json', 'contracts/connectors/h11_account_entitlement_boundary_candidate.v0.json', 'contracts/connectors/h11_storefront_rights_safety_candidate.v0.json', 'contracts/connectors/h11_storefront_fixture_replay_result.v0.json']
