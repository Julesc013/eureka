#!/usr/bin/env python3
"""Run the P98 local source cache dry-run over approved examples."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    except SourceCachePolicyError as exc:
    ...
    report = run_source_cache_dry_run(
        roots,
        strict=args.strict,
