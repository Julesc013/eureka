#!/usr/bin/env python3
"""Print SCOUT relations for bundled candidate examples."""
...
def main(argv: Sequence[str] | None = None, stdout: TextIO = sys.stdout) -> int:
    ...
    run = build_scout_run(args.seed, load_candidate_index_from_examples())
    print(json.dumps({"schema_version": "scout_relations_cli_result.v0", "relations": run["relations"]}, indent=2, sort_keys=True), file=stdout)
    return 0
