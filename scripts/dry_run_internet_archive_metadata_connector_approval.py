#!/usr/bin/env python3
"""Emit a stdout-only hypothetical IA metadata connector approval record."""
...
def build_record() -> dict[str, Any]:
    return {
        ...
        "created_by_tool": "dry_run_internet_archive_metadata_connector_approval_v0",
        "connector_ref": {
            "connector_id": "internet_archive_metadata_connector",
            "connector_label": "Internet Archive metadata connector",
            "source_family": "internet_archive",
            "connector_version": "dry-run",
            "source_inventory_ref": "control/inventory/sources/internet-archive-placeholder.source.json",
            "source_status": "approval_required",
            "limitations": ["Dry-run only; no connector execution."],
        },
