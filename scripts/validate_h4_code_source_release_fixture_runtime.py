...
CONTRACT_FILES = ('contracts/connectors/h4_code_source_fixture.v0.json', 'contracts/connectors/h4_code_source_normalized_record.v0.json', 'contracts/connectors/h4_source_identity_candidate.v0.json', 'contracts/connectors/h4_release_identity_candidate.v0.json', 'contracts/connectors/h4_source_to_binary_relation_candidate.v0.json', 'contracts/connectors/h4_release_asset_candidate.v0.json', 'contracts/connectors/h4_code_source_fixture_replay_result.v0.json')
