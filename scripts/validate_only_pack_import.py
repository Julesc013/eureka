...
# Compatibility text preserved for script-inspection tests:
# validate_only_pack_import_tool_v0; FORBIDDEN_OUTPUT_REPO_ROOTS; site/dist; control/inventory
# validate_pack_set.validate_pack_root; _output_path_policy_error; network_performed
...
_TARGET = Path(__file__).resolve().parents[1] / 'tools/validators/validate_only_pack_import.py'
