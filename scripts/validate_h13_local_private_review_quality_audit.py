...
def validate_scripts(root: Path, errors: list[str]) -> None:
    ...
    forbidden_checks = [
        ...
        [sys.executable, "scripts/summarize_h13_local_private_quality_delta.py", "--input-dir", "examples/connectors/h13_local_private/review_integration", "--output", "data/public_index/h13.json"],
