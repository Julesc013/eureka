#!/usr/bin/env python3
"""Print SCOUT source trust observations for bundled candidate examples."""
...
from runtime.scout import build_source_trust_observation, load_candidate_index_from_examples  # noqa: E402
...
def main(argv: Sequence[str] | None = None, stdout: TextIO = sys.stdout) -> int:
    ...
    payload = build_source_trust_observation(candidates)
