...
- `contracts/source/sync/source_sync_job_kind.v0.json`
- `contracts/source/sync/source_sync_worker_job.v0.json`
- `contracts/source/sync/source_sync_worker_manifest.v0.json`
- `contracts/surface/ui/contracts/stored_exports.ui_contract.yaml`
- `contracts/view/models/ui/stored_exports.view_model.yaml`
...
- `contracts/schema/control/previews/h13/connectors/local_cas_import_boundary_candidate.v0.json`
...
- `examples/sources/sync/minimal_ia_metadata_sync_job_v0/SOURCE_SYNC_WORKER_JOB.json`
- `examples/sources/sync/minimal_manual_source_review_job_v0/SOURCE_SYNC_WORKER_JOB.json`
- `examples/sources/sync/minimal_wayback_availability_sync_job_v0/SOURCE_SYNC_WORKER_JOB.json`
