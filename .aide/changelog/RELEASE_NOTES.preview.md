...
- Added: runtime/local/appliance runtime composition API. (5f9ac9870626)
...
- Added: runtime/local/service read-only localhost service API. (15a46c118f90)
...
- Added: runtime/local/worker, worker runner scripts, LOCAL-09 policies, inventories, docs, tests, validator, queue handoff, and audit pack. (5488d5b29987)
...
- Fixed: moved unresolved contract taxonomy artifacts to contracts/schema/control (ede77d3cb101)
