...
- `docs/reference/COMPARE_PAGE_VIEW_MODEL_CONTRACT.md`
...
- `tests/contracts/test_download_evidence_absence_compare_view_models.py`
- `control/audits/track-a-09-download-evidence-absence-compare-view-models-v0/README.md`
- `control/audits/track-a-09-download-evidence-absence-compare-view-models-v0/track_a_09_report.json`
- `control/audits/track-a-09-download-evidence-absence-compare-view-models-v0/validation.md`
...
- `.aide/queue/TRACK-A-09/task.yaml`
- `.aide/queue/TRACK-A-09/status.yaml`
- `.aide/queue/TRACK-A-09/evidence/changed-files.md`
- `.aide/queue/TRACK-A-09/evidence/validation.md`
- `.aide/queue/TRACK-A-09/evidence/track-a-contract-result.md`
- `.aide/queue/TRACK-A-09/evidence/remaining-risks.md`

No runtime, surface, native, connector, source sync, node runtime, pack import
runtime, review runtime, generated product behavior, or generated site artifact
files are intentionally changed.
