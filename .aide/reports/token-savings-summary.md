...
- `.aide/context/latest-task-packet.md`: 4836 chars / 1209 approx tokens / within_budget
- `.aide/context/latest-context-packet.md`: 1828 chars / 457 approx tokens / within_budget
- `.aide/context/latest-review-packet.md`: 5586 chars / 1397 approx tokens / within_budget
- `.aide/verification/latest-verification-report.md`: 4572 chars / 1143 approx tokens / within_budget

## Named Baselines

- `root_history_baseline`: 275605 chars / 68902 approx tokens
- `review_baseline`: 21478 chars / 5370 approx tokens
- `repo_context_baseline`: 242624 chars / 60656 approx tokens

## Compact-To-Baseline Comparisons

- `.aide/context/latest-task-packet.md` vs `root_history_baseline`: 98.2% estimated reduction (1209 vs 68902 approx tokens)
- `.aide/context/latest-review-packet.md` vs `review_baseline`: 74.0% estimated reduction (1397 vs 5370 approx tokens)
- `.aide/context/latest-context-packet.md` vs `repo_context_baseline`: 99.2% estimated reduction (457 vs 60656 approx tokens)
...
- `AGENTS.md` (generated_adapter): 1606 approx tokens
- `.aide/prompts/codex-token-mode.md` (baseline_surface): 1593 approx tokens
- `.aide/context/latest-review-packet.md` (review_packet): 1397 approx tokens
- `.aide/evals/runs/latest-golden-tasks.md` (eval_report): 1305 approx tokens
- `.aide/context/latest-task-packet.md` (task_packet): 1209 approx tokens
