...
def _is_hunt_command_mutation_route(path: str) -> bool:
    ...
    if len(parts) == 4 and parts[0] == "hunt" and parts[2] == "ai-escalation":
        return parts[3] == "preflight"
    ...
    if len(parts) == 6 and parts[:3] == ["api", "v1", "hunt"] and parts[4] == "ai-escalation":
