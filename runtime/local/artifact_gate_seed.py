...
_SOURCE_COLLECTION_CURATED_GATE_CLOSING_BATCH_SIZE = 7
_SOURCE_COLLECTION_CURATED_GATE_CLOSING_MIN_GATE_COUNT = 18
_CURATED_SOURCE_COLLECTION_TARGETS: tuple[dict[str, Any], ...] = (
    ...
    {
        "artifact_gate_candidate_reason": "curated concrete Windows media player target after broad Windows app candidates remain unusable",
        "artifact_gate_excluded": False,
        "artifact_type": "software",
        "artifact_verified": False,
        "candidate_id": "artifact-gate-curated:vlc-3-0-20-windows",
        "evidence_hints": [
            "Official VideoLAN pages identify VLC 3.0.20 Vetinari and Windows-related fixes.",
            "Curated because broad Windows app candidates are not concrete artifact identities.",
        ],
        "gate_eligible": False,
        "gate_exclusion_reason": "curated_concrete_source_target",
        "matched_queries": ["Windows 7 apps"],
        ...
        "provenance": {
            "source": "curated_source_collection_target",
            "source_kind": "source_observation_batch_06_curation",
            "source_ref": "SOURCE-OBSERVATION-BATCH-06",
        },
        "query_hints": [
            "VLC 3.0.20 Vetinari",
            "Windows media player",
            "official VideoLAN release/changelog/security pages",
        ],
        "record_state": "",
        "review_state": "unreviewed",
        "safe_next_action": "observe official release/changelog/security metadata only; do not download installers or archives",
        "schema_version": CANDIDATE_SCHEMA_VERSION,
        "source_authority": "curated_target",
        "source_family": "curated_source_target",
        "source_hints": [
            "https://images.videolan.org/vlc/releases/3.0.20.html",
            "https://code.videolan.org/videolan/vlc/-/raw/3.0.x/NEWS",
            "https://images.videolan.org/security/sb-vlc3020.html",
        ],
        "source_index_document_id": "curated-source-target:vlc-3-0-20-windows",
        "source_observations": [],
        "status": "candidate",
        "summary": "Concrete VLC 3.0.20 Vetinari Windows media player identity selected from broad Windows app scope.",
        "title": "VLC 3.0.20 Vetinari",
        "verification_scope": "source_lead_only",
    },
    {
        "artifact_gate_candidate_reason": "curated concrete Windows image editor target after broad Windows app candidates remain unusable",
        "artifact_gate_excluded": False,
        "artifact_type": "software",
        "artifact_verified": False,
        "candidate_id": "artifact-gate-curated:gimp-2-10-38-windows",
        "evidence_hints": [
            "Official GIMP pages identify GIMP 2.10.38, release date, and Windows build context.",
            "Curated because broad Windows app candidates are not concrete artifact identities.",
        ],
        "gate_eligible": False,
        "gate_exclusion_reason": "curated_concrete_source_target",
        ...
        "query_hints": [
            ...
            "official GIMP release and downloads pages",
        ],
        "record_state": "",
        "review_state": "unreviewed",
        "safe_next_action": "observe official release/downloads metadata only; do not download installers or archives",
        "schema_version": CANDIDATE_SCHEMA_VERSION,
        "source_authority": "curated_target",
        "source_family": "curated_source_target",
        "source_hints": [
        ...
        "source_index_document_id": "curated-source-target:gimp-2-10-38-windows",
        "source_observations": [],
        "status": "candidate",
    ...
    {
        "artifact_gate_candidate_reason": "curated concrete Windows BitTorrent client target for gate-closing source observation",
        "artifact_gate_excluded": False,
        "artifact_type": "software",
        "artifact_verified": False,
        "candidate_id": "artifact-gate-curated:qbittorrent-4-6-4-windows",
        "evidence_hints": [
            "Official qBittorrent project pages identify 4.6.4 release metadata and Windows package context.",
            "Curated for Batch 09 evidence collection after eighteen earlier concrete identities are counted.",
        ],
        "gate_eligible": False,
        "gate_exclusion_reason": "curated_concrete_source_target",
        "matched_queries": ["Windows 7 apps"],
        ...
        "provenance": {
            "source": "curated_source_collection_target",
            "source_kind": "source_observation_batch_09_curation",
            "source_ref": "SOURCE-OBSERVATION-BATCH-09",
        },
        "query_hints": [
            "qBittorrent 4.6.4",
            "Windows BitTorrent client",
            "official qBittorrent release tag and project file page",
        ],
        "record_state": "",
        "review_state": "unreviewed",
        "safe_next_action": "observe official release-tag and project-file metadata only; do not download installers or archives",
        "schema_version": CANDIDATE_SCHEMA_VERSION,
        "source_authority": "curated_target",
        "source_family": "curated_source_target",
        "source_hints": [
            "https://github.com/qbittorrent/qBittorrent/releases/tag/release-4.6.4",
            "https://sourceforge.net/projects/qbittorrent/files/qbittorrent-win32/qbittorrent-4.6.4/",
        ],
        "source_index_document_id": "curated-source-target:qbittorrent-4-6-4-windows",
        "source_observations": [],
        "status": "candidate",
        "summary": "Concrete qBittorrent 4.6.4 Windows BitTorrent client identity selected from broad Windows app scope.",
        "title": "qBittorrent 4.6.4 for Windows",
        "verification_scope": "source_lead_only",
    },
    {
        "artifact_gate_candidate_reason": "curated concrete Windows file-transfer client target for gate-closing source observation",
        "artifact_gate_excluded": False,
        "artifact_type": "software",
        "artifact_verified": False,
        "candidate_id": "artifact-gate-curated:filezilla-pro-3-67-0-windows",
        "evidence_hints": [
            "Official FileZilla Pro pages identify 3.67.0 release metadata and Windows client context.",
            "Curated for Batch 09 evidence collection after eighteen earlier concrete identities are counted.",
        ],
        "gate_eligible": False,
        "gate_exclusion_reason": "curated_concrete_source_target",
        ...
        "query_hints": [
            "FileZilla Pro 3.67.0",
            "Windows FTP SFTP client",
            "official FileZilla Pro version history",
        ],
        "record_state": "",
        "review_state": "unreviewed",
        "safe_next_action": "observe official version-history and product-page metadata only; do not purchase, download, or fetch installers",
        "schema_version": CANDIDATE_SCHEMA_VERSION,
        "source_authority": "curated_target",
        "source_family": "curated_source_target",
        "source_hints": [
            "https://filezillapro.com/filezilla-pro-version-history/",
            "https://filezillapro.com/download/",
        ],
        "source_index_document_id": "curated-source-target:filezilla-pro-3-67-0-windows",
        "source_observations": [],
        "status": "candidate",
        "summary": "Concrete FileZilla Pro 3.67.0 Windows file-transfer client identity selected from broad Windows app scope.",
        "title": "FileZilla Pro 3.67.0 for Windows",
        "verification_scope": "source_lead_only",
    },
    {
        "artifact_gate_candidate_reason": "curated concrete Windows streaming application target for gate-closing source observation",
        "artifact_gate_excluded": False,
        "artifact_type": "software",
        "artifact_verified": False,
        "candidate_id": "artifact-gate-curated:obs-studio-30-1-windows",
        "evidence_hints": [
            "Official OBS pages identify 30.1 release metadata and Windows application context.",
            "Curated for Batch 09 evidence collection after eighteen earlier concrete identities are counted.",
        ],
        "gate_eligible": False,
        "gate_exclusion_reason": "curated_concrete_source_target",
        ...
        "query_hints": [
            "OBS Studio 30.1",
            "Windows recording streaming software",
            "official OBS release notes",
        ],
        "record_state": "",
        "review_state": "unreviewed",
        "safe_next_action": "observe official release-note metadata only; do not download installers or archives",
        ...
        "source_index_document_id": "curated-source-target:obs-studio-30-1-windows",
        "source_observations": [],
        "status": "candidate",
        "summary": "Concrete OBS Studio 30.1 Windows recording and streaming identity selected from broad Windows app scope.",
        "title": "OBS Studio 30.1 for Windows",
        "verification_scope": "source_lead_only",
    },
    {
        "artifact_gate_candidate_reason": "curated concrete Windows video transcoder target for gate-closing source observation",
        "artifact_gate_excluded": False,
        "artifact_type": "software",
        "artifact_verified": False,
        "candidate_id": "artifact-gate-curated:handbrake-1-7-3-windows",
        "evidence_hints": [
            "Official HandBrake news identifies 1.7.3 release metadata and Windows runtime context.",
            "Curated for Batch 09 evidence collection after eighteen earlier concrete identities are counted.",
        ],
        "gate_eligible": False,
        "gate_exclusion_reason": "curated_concrete_source_target",
        ...
        "query_hints": [
            "HandBrake 1.7.3",
            "Windows video transcoder",
            "official HandBrake release news",
        ],
        "record_state": "",
        "review_state": "unreviewed",
        "safe_next_action": "observe official release/news metadata only; do not download installers or archives",
        ...
        "source_authority": "curated_target",
        "source_family": "curated_source_target",
        "source_hints": ["https://handbrake.fr/news.php?article=52"],
        "source_index_document_id": "curated-source-target:handbrake-1-7-3-windows",
        "source_observations": [],
        "status": "candidate",
        "summary": "Concrete HandBrake 1.7.3 Windows video transcoder identity selected from broad Windows app scope.",
        "title": "HandBrake 1.7.3 for Windows",
        "verification_scope": "source_lead_only",
    },
    {
        "artifact_gate_candidate_reason": "curated concrete Windows diff/merge utility target for gate-closing source observation",
        "artifact_gate_excluded": False,
        "artifact_type": "software",
        "artifact_verified": False,
        "candidate_id": "artifact-gate-curated:winmerge-2-16-40-windows",
        "evidence_hints": [
            "Official WinMerge project pages identify 2.16.40 release metadata and Windows diff/merge context.",
            "Curated for Batch 09 evidence collection after eighteen earlier concrete identities are counted.",
        ],
        "gate_eligible": False,
        "gate_exclusion_reason": "curated_concrete_source_target",
        ...
        "query_hints": [
            "WinMerge 2.16.40",
            "Windows visual diff merge utility",
            "official WinMerge release history and project file page",
        ],
        "record_state": "",
        "review_state": "unreviewed",
        "safe_next_action": "observe official release-history and project-file metadata only; do not download installers or archives",
        "schema_version": CANDIDATE_SCHEMA_VERSION,
        "source_authority": "curated_target",
        "source_family": "curated_source_target",
        "source_hints": [
            "https://github.com/WinMerge/winmerge/wiki/Release-History",
            "https://sourceforge.net/projects/winmerge/files/stable/2.16.40/",
        ],
        "source_index_document_id": "curated-source-target:winmerge-2-16-40-windows",
        "source_observations": [],
        "status": "candidate",
        "summary": "Concrete WinMerge 2.16.40 Windows visual diff and merge identity selected from broad Windows app scope.",
        "title": "WinMerge 2.16.40 for Windows",
        "verification_scope": "source_lead_only",
    },
    {
        "artifact_gate_candidate_reason": "curated concrete Windows e-book manager target for gate-closing source observation",
        "artifact_gate_excluded": False,
        "artifact_type": "software",
        "artifact_verified": False,
        "candidate_id": "artifact-gate-curated:calibre-7-8-0-windows",
        "evidence_hints": [
            "Official calibre pages identify 7.8 release metadata and 7.8.0 Windows package context.",
            "Curated for Batch 09 evidence collection after eighteen earlier concrete identities are counted.",
        ],
        "gate_eligible": False,
        "gate_exclusion_reason": "curated_concrete_source_target",
        ...
        "query_hints": [
            "calibre 7.8.0",
            "Windows e-book manager",
            "official calibre release notes and release directory",
        ],
        "record_state": "",
        "review_state": "unreviewed",
        "safe_next_action": "observe official release-note and release-directory metadata only; do not download installers or archives",
        "schema_version": CANDIDATE_SCHEMA_VERSION,
        "source_authority": "curated_target",
        "source_family": "curated_source_target",
        "source_hints": [
            "https://calibre-ebook.com/whats-new",
            "https://download.calibre-ebook.com/7.8.0/",
        ],
        "source_index_document_id": "curated-source-target:calibre-7-8-0-windows",
        "source_observations": [],
        "status": "candidate",
        "summary": "Concrete calibre 7.8.0 Windows e-book manager identity selected from broad Windows app scope.",
        "title": "calibre 7.8.0 for Windows",
        "verification_scope": "source_lead_only",
    },
    {
        "artifact_gate_candidate_reason": "curated concrete Windows programming language runtime target for gate-closing source observation",
        "artifact_gate_excluded": False,
        "artifact_type": "software",
        "artifact_verified": False,
        "candidate_id": "artifact-gate-curated:python-3-12-3-windows",
        "evidence_hints": [
            "Official Python.org release page identifies Python 3.12.3, release date, and Windows installer records.",
            "Curated for Batch 09 evidence collection after eighteen earlier concrete identities are counted.",
        ],
        "gate_eligible": False,
        "gate_exclusion_reason": "curated_concrete_source_target",
        ...
        "query_hints": [
            "Python 3.12.3",
            "Windows programming language runtime",
            "official Python.org release page",
        ],
        "record_state": "",
        "review_state": "unreviewed",
        "safe_next_action": "observe official release-page metadata only; do not download installers or archives",
        "schema_version": CANDIDATE_SCHEMA_VERSION,
        "source_authority": "curated_target",
        "source_family": "curated_source_target",
        "source_hints": ["https://www.python.org/downloads/release/python-3123/"],
        "source_index_document_id": "curated-source-target:python-3-12-3-windows",
        "source_observations": [],
        "status": "candidate",
        "summary": "Concrete Python 3.12.3 Windows runtime identity selected from broad Windows app scope.",
...
def create_source_collection_plan(
    ...
    *,
    ...
    if curated_candidate_count:
        ...
        curated_batch_size = (
            _SOURCE_COLLECTION_CURATED_GATE_CLOSING_BATCH_SIZE
            if reviewed_gate_count >= _SOURCE_COLLECTION_CURATED_GATE_CLOSING_MIN_GATE_COUNT
            else (
