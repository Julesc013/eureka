        ...
        outputs.append(
            {
                ...
                "output_contract_ref": record.get("output_contract_ref", "contracts/control_schemas/policies/node/work_unit_result.v0.json"),
                "output_ref": None,
        ...
        outputs.append(
            {
                ...
                "output_contract_ref": "contracts/control_schemas/policies/node/work_unit_result.v0.json",
                "output_ref": None,
...
def _output_contract_refs(workunit: Mapping[str, Any]) -> list[str]:
    refs = {"contracts/control_schemas/policies/node/work_unit_result.v0.json"}
