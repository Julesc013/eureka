"""Fixture-only normalizer for local_removable_media_metadata."""
...
def normalize(raw_fixture: Mapping[str, Any], policy: Mapping[str, Any] | None = None) -> dict[str, Any]:
    return normalize_h13_local_private_fixture(raw_fixture, "local_removable_media_metadata", policy)
