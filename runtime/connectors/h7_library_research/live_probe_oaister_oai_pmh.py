"""Fail-closed H7 metadata live-probe wrapper for oaister_oai_pmh."""
...
SOURCE_ID = "oaister_oai_pmh"
DEFAULT_ENDPOINT_OR_METADATA_CLASS = "oai_pmh_single_record_metadata_future"
