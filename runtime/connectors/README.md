...
- connectors may also pair bounded representations with tiny recorded payload fixtures so later acquisition slices can retrieve deterministic local bytes without introducing live downloading
