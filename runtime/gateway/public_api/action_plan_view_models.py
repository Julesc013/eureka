...
def action_plan_envelope_to_view_model(envelope: Mapping[str, Any]) -> dict[str, Any]:
    view_model: dict[str, Any] = {
        ...
        "notices": _coerce_notice_list(envelope.get("notices"), "action_plan.notices"),
    }
...
def _coerce_actions(value: Any, field_name: str) -> list[dict[str, Any]]:
    ...
    for index, item in enumerate(value):
        ...
        action: dict[str, Any] = {
            "action_id": _require_string(item.get("action_id"), f"{field_name}[{index}].action_id"),
            "label": _require_string(item.get("label"), f"{field_name}[{index}].label"),
            "kind": _require_string(item.get("kind"), f"{field_name}[{index}].kind"),
