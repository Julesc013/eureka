...
- transport-neutral public action-plan boundary for building bounded recommended, available, and unavailable next steps for one resolved target
...
- bounded action plans propagated across the public boundary and shared-surface mappings without implying execution, installer, launcher, or final policy-engine behavior
