        ...
        self.assertEqual(
            manifest,
            {
                ...
                "source": {
                    ...
                    "locator": "contracts/control_schemas/fixtures/archive/software/synthetic_resolution_fixture.json",
                },
                "evidence": [
                    {
                        "claim_kind": "label",
                    ...
                    },
                    {
                        ...
                        "claim_value": "contracts/control_schemas/fixtures/archive/software/synthetic_resolution_fixture.json",
                        "asserted_by_family": "synthetic_fixture",
                        "asserted_by_label": "Synthetic Fixture",
                        "evidence_kind": "recorded_fixture",
                        "evidence_locator": "contracts/control_schemas/fixtures/archive/software/synthetic_resolution_fixture.json",
                ...
                "representations": [
                    ...
                    },
                    {
                        ...
                        "access_locator": "contracts/control_schemas/fixtures/archive/software/payloads/synthetic-demo-app-package.zip",
                        "is_direct": True,
                        "is_fetchable": True,
                    }
                ],
