        ...
        self.assertEqual(
            manifest,
            {
                ...
                "generated_from": {
                    ...
                    "source_locator": "contracts/schema/control/fixtures/archive/software/synthetic_resolution_fixture.json",
                },
                ...
                "source": {
                    ...
                    "locator": "contracts/schema/control/fixtures/archive/software/synthetic_resolution_fixture.json",
                },
                "evidence": [
                    {
                        "claim_kind": "label",
                    ...
                    },
                    {
                        ...
                        "claim_value": "contracts/schema/control/fixtures/archive/software/synthetic_resolution_fixture.json",
                        "asserted_by_family": "synthetic_fixture",
                        "asserted_by_label": "Synthetic Fixture",
                        "evidence_kind": "recorded_fixture",
                        "evidence_locator": "contracts/schema/control/fixtures/archive/software/synthetic_resolution_fixture.json",
                ...
                "representations": [
                    {
                        ...
                        "access_kind": "inspect",
                        "access_locator": "contracts/schema/control/fixtures/archive/software/synthetic_resolution_fixture.json",
                        "is_direct": False,
                        "is_fetchable": True,
                    },
                    {
                        ...
                        "access_kind": "view",
                        "access_locator": "contracts/schema/control/fixtures/archive/software/synthetic_resolution_fixture.json#fixture:software/synthetic-demo-app@1.0.0",
                        "is_direct": False,
                        "is_fetchable": False,
                    },
                    {
                        ...
                        "access_locator": "contracts/schema/control/fixtures/archive/software/payloads/synthetic-demo-app-package.zip",
                        "is_direct": True,
                        "is_fetchable": True,
                    }
                ],
