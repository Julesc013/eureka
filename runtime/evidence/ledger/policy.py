...
from runtime.evidence.ledger.errors import EvidenceLedgerPolicyError


REPO_ROOT = Path(__file__).resolve().parents[3]
DRY_RUN_EXAMPLES_ROOT = REPO_ROOT / "examples" / "evidence" / "ledger" / "dry_run" / "dry_run"
EVIDENCE_LEDGER_EXAMPLES_ROOT = REPO_ROOT / "examples" / "evidence" / "ledger" / "dry_run"
