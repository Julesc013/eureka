"""Source-specific H5 live-probe metadata wrapper for microsoft_runtime_redistributables."""

from __future__ import annotations

from typing import Any, Mapping

from archive.prototypes.legacy_runtime.connectors.h5_vendor_update_driver.live_probe_common import build_metadata_request, normalize_h5_vendor_update_live_probe_result, parse_metadata_response

SOURCE_ID = "microsoft_runtime_redistributables"
