"""Fail-closed H8 live-probe wrapper for Generic technical-document collection metadata."""
...
from archive.prototypes.legacy_runtime.connectors.h8_manuals_docs_standards.live_probe_common import (
    SOURCE_CONFIGS,
    build_h8_manuals_docs_live_probe_result,
)

SOURCE_ID = "generic_technical_document_collection"
