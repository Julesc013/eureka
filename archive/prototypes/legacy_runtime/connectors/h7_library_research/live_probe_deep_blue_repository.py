"""Fail-closed H7 metadata live-probe wrapper for deep_blue_repository."""
...
SOURCE_ID = "deep_blue_repository"
DEFAULT_ENDPOINT_OR_METADATA_CLASS = "repository_record_metadata_lookup_future"
