"""Source-specific fail-closed H11 live-probe wrapper for itch.io storefront metadata."""
...
SOURCE_ID = "itchio_storefront_metadata"
...
def build_request_url_or_metadata_request(request: Mapping[str, Any], policy_bundle: Mapping[str, Any]) -> dict[str, Any]:
    ...
    if request.get("source_id") != SOURCE_ID:
        raise ValueError("request source_id does not match itchio_storefront_metadata")
