"""Source-specific fail-closed H11 live-probe wrapper for Generic commercial software marketplace metadata."""
...
from archive.prototypes.legacy_runtime.connectors.h11_storefront.live_probe_common import SOURCE_CONFIGS, build_h11_storefront_live_probe_result

SOURCE_ID = "generic_commercial_software_marketplace"
...
def build_request_url_or_metadata_request(request: Mapping[str, Any], policy_bundle: Mapping[str, Any]) -> dict[str, Any]:
    ...
    if request.get("source_id") != SOURCE_ID:
        raise ValueError("request source_id does not match generic_commercial_software_marketplace")
