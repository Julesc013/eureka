        ...
        "moves": [
            {
                ...
                "target_path": "control/schemas/audits/audits/example_audit_report.v0.json",
                "action": "move",
            ...
            },
            {
                ...
                "target_path": "control/schemas/fixtures/h1/connectors/metadata_fixture_replay_result.v0.json",
            ...
            },
            {
                ...
                "target_path": "control/schemas/previews/native/native_release_candidate_preview.v0.json",
                "action": "move",
            ...
            },
            {
                ...
                "target_path": "control/schemas/deprecated/domain/mystery.v0.json",
                "action": "investigate",
...
class ContractTaxonomyMigrationTests(unittest.TestCase):
    ...
    def test_executor_moves_only_batch_classes(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertTrue((repo / "control/schemas/audits/audits/example_audit_report.v0.json").exists())
            self.assertTrue((repo / "control/schemas/fixtures/h1/connectors/metadata_fixture_replay_result.v0.json").exists())
            self.assertTrue((repo / "control/schemas/previews/native/native_release_candidate_preview.v0.json").exists())
    ...
    def test_validator_detects_accidental_product_contract_move(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            repo = Path(tmp)
            write(repo / "control/schemas/audits/domain/source_record.v0.json", "{}\n")
            payload = {
                "task": "R0-03B-1",
                "status": "pass",
                "schemas_deleted": 0,
                ...
                "moved": [
                    {
                        "source_path": "contracts/domain/source_record.v0.json",
                        "target_path": "control/schemas/audits/domain/source_record.v0.json",
    ...
    def test_validator_validates_reference_and_shim_reports(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            repo = Path(tmp)
            write(repo / "tests/operations/test_example.py", "SCHEMA = 'control/schemas/audits/audits/example_audit_report.v0.json'\n")
            migration = {
                "moved": [{"source_path": "contracts/audits/example_audit_report.v0.json", "target_path": "control/schemas/audits/audits/example_audit_report.v0.json"}],
                "blocked": [],
            }
            refs = {
                "updates": [
                    {
                        ...
                        "new_reference": "control/schemas/audits/audits/example_audit_report.v0.json",
                        "reason": "test",
                    }
                ],
                ...
                "shims": [
                    {
                        ...
                        "new_path": "control/schemas/audits/audits/example_audit_report.v0.json",
                        "shim_kind": "none",
