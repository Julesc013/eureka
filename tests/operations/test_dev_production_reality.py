...
""",
    ...
    write(root / "control/schemas/previews/h1/connectors/live_probe_result.v0.json", "{}")
...
class DevProductionRealityTests(unittest.TestCase):
    ...
    def test_audit_detects_fixture_runtime_leakage_placeholders_and_contract_taxonomy(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual("preview_contract", artifacts["control/schemas/previews/h1/connectors/live_probe_result.v0.json"]["artifact_kind"])
