...
SCHEMA = REPO_ROOT / "contracts" / "schema" / "control" / "policies" / "packs" / "contribution_pack.v0.json"
EXAMPLE_PACK = REPO_ROOT / "examples" / "packs" / "contribution" / "minimal_contribution_pack_v0"
