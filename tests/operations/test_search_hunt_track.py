...
class SearchHuntTrackTests(unittest.TestCase):
    ...
    def test_next_task_is_hunt_01_or_completed_post_hunt_task(self) -> None:
        ...
        self.assertRegex(
            queue,
            r"current_recommended_task: (HUNT-(0[1-9]|1[0-2])|SYN-00|F0-00|HUNT-REMEDIATION|HUNT-TO-MAIN-PROMOTION-REVIEW|DEV-AND-IA-[A-Z0-9-]+|REPO-LAYOUT-[A-Z0-9-]+|IA-HUNT-BRIDGE-00)\b",
        )
