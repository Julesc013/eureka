...
SCRIPT = REPO_ROOT / "scripts" / "check_rust_query_planner_parity.py"


class RustQueryPlannerParityScriptTestCase(unittest.TestCase):
    def test_script_json_output_parses(self) -> None:
        ...
        self.assertEqual(payload["check_id"], "rust_query_planner_parity_candidate_v0")
        ...
        self.assertGreaterEqual(payload["structure"]["case_count"], 16)
