...
def valid_summary() -> dict:
    return {
        ...
        "failed_modules": [],
        "failure_families": [],
        "stdout_path": ".aide.local/test-runs/run/stdout.txt",
        "stderr_path": ".aide.local/test-runs/run/stderr.txt",
        "exit_code_path": ".aide.local/test-runs/run/exit.txt",
        "environment_path": ".aide.local/test-runs/run/environment.json",
        "tail_excerpt": "OK",
        "generated_by": "test",
    }
