...
SCRIPT = REPO_ROOT / "scripts" / "validate_search_interaction_contract.py"


class SearchInteractionValidatorScriptTest(unittest.TestCase):
    ...
    def test_validator_json_records_non_claims(self) -> None:
