...
from runtime.local.foundry import contribution_review, pack_import_preview, pack_quarantine
...
class PackImportPreviewTests(unittest.TestCase):
    def test_import_preview_does_not_import(self) -> None:
        bundle = pack_quarantine.build_full_quarantine_bundle(load_json("examples/packs/exports/evidence_pack_export_v0.json"))
    ...
    def test_import_preview_projects_source_records(self) -> None:
        bundle = pack_quarantine.build_full_quarantine_bundle(load_json("examples/packs/exports/source_pack_export_v0.json"))
        preview = bundle["import_preview"]
    ...
    def test_contribution_review_seed_is_not_review_decision(self) -> None:
        seed = pack_quarantine.build_full_quarantine_bundle(load_json("examples/packs/exports/contribution_pack_export_v0.json"))["contribution_review_seed"]
    ...
    def test_trust_preview_does_not_create_trust(self) -> None:
        preview = pack_quarantine.build_full_quarantine_bundle(load_json("examples/packs/exports/evidence_pack_export_v0.json"))["trust_preview"]
    ...
    def test_revocation_preview_does_not_revoke(self) -> None:
        preview = pack_quarantine.build_full_quarantine_bundle(load_json("examples/packs/exports/policy_blocked_pack_export_v0.json"))["revocation_preview"]
    ...
    def test_import_preview_acceptance_claim_is_rejected(self) -> None:
        preview = pack_quarantine.build_full_quarantine_bundle(load_json("examples/packs/exports/evidence_pack_export_v0.json"))["import_preview"]
