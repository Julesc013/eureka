...
from runtime.local_foundry import pack_quarantine
...
class PackQuarantineRuntimeTests(unittest.TestCase):
    ...
    def test_exported_source_pack_can_be_quarantined(self) -> None:
        pack = load_json("examples/pack_exports/source_pack_export_v0.json")
    ...
    def test_contribution_pack_can_be_quarantined(self) -> None:
        pack = load_json("examples/pack_exports/contribution_pack_export_v0.json")
        result = pack_quarantine.build_full_quarantine_bundle(pack)["quarantine_result"]
    ...
    def test_policy_blocked_pack_remains_blocked(self) -> None:
        pack = load_json("examples/pack_exports/policy_blocked_pack_export_v0.json")
        result = pack_quarantine.build_full_quarantine_bundle(pack)["quarantine_result"]
    ...
    def test_quarantine_result_is_not_accepted_imported_or_submitted(self) -> None:
        result = pack_quarantine.build_full_quarantine_bundle(load_json("examples/pack_exports/evidence_pack_export_v0.json"))["quarantine_result"]
