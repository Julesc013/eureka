...
from archive.prototypes.legacy_runtime.connectors.h6_web_archive_news_event.fixture_loader import load_h6_web_archive_fixture
from archive.prototypes.legacy_runtime.connectors.h6_web_archive_news_event.normalizer_common import H6_FIXTURE_KINDS, H6_SOURCE_IDS
...
class H6WebArchiveFixtureRuntimeTests(unittest.TestCase):
    def test_all_normalizers_handle_all_fixture_kinds(self) -> None:
        for source_id in H6_SOURCE_IDS:
            module = importlib.import_module(f"archive.prototypes.legacy_runtime.connectors.h6_web_archive_news_event.{source_id}")
    ...
    def test_missing_optional_fields_produce_limitations(self) -> None:
        ...
        normalized = importlib.import_module("archive.prototypes.legacy_runtime.connectors.h6_web_archive_news_event.wayback_cdx_memento").normalize(fixture)
