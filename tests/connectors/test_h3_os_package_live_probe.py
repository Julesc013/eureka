...
from control.prototypes.legacy_runtime.connectors.h3_os_package_archives.live_probe_common import (
    H3_SOURCE_IDS,
    SOURCE_CONFIGS,
...
class H3OSPackageLiveProbeTests(unittest.TestCase):
    ...
    def test_source_modules_normalize_payloads(self):
        for source_id in H3_SOURCE_IDS:
            module = importlib.import_module(f"control.prototypes.legacy_runtime.connectors.h3_os_package_archives.live_probe_{source_id}")
