...
from archive.prototypes.legacy_runtime.connectors.h12_retro_community.normalizer_common import H12_SOURCE_IDS, detect_h12_product_boundary_violations, detect_h12_truth_boundary_violations
...
class H12RetroCommunityFixtureRuntimeTests(unittest.TestCase):
    ...
    def test_missing_optional_fields_are_limited_not_fabricated(self) -> None:
        ...
        record = importlib.import_module("archive.prototypes.legacy_runtime.connectors.h12_retro_community.winworld_metadata").normalize(fixture)
