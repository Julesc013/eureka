...
from runtime.connectors.h10_games_emulation.normalizer_common import H10_FIXTURE_KINDS, H10_SOURCE_IDS, detect_h10_product_boundary_violations, detect_h10_truth_boundary_violations
...
class H10GamesEmulationFixtureRuntimeTests(unittest.TestCase):
    ...
    def test_missing_optional_fields_produce_limitations(self) -> None:
        ...
        normalized = importlib.import_module("runtime.connectors.h10_games_emulation.mobygames").normalize(fixture)
