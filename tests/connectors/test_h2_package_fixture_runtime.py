...
from runtime.connectors.h2_package_registries.fixture_loader import load_h2_package_fixture
...
def normalizer(source_id):
    module = __import__(f"runtime.connectors.h2_package_registries.{source_id}", fromlist=["normalize"])
