...
from archive.prototypes.legacy_runtime.connectors.h1_metadata_wave.quality_delta import (
    build_h1_quality_delta,
    detect_h1_quality_overclaim,
)
from archive.prototypes.legacy_runtime.connectors.h1_metadata_wave.review_integration import (
...
from archive.prototypes.legacy_runtime.connectors.h1_metadata_wave.wave_postmortem import (
...
RUNTIME_FILES = (
    REPO_ROOT / "archive/prototypes/legacy_runtime/connectors/h1_metadata_wave/review_integration.py",
    REPO_ROOT / "archive/prototypes/legacy_runtime/connectors/h1_metadata_wave/quality_delta.py",
    REPO_ROOT / "archive/prototypes/legacy_runtime/connectors/h1_metadata_wave/wave_postmortem.py",
)
