...
from archive.prototypes.legacy_runtime.connectors.h4_code_source_release.live_probe_common import (
    H4_SOURCE_IDS,
    SOURCE_CONFIGS,
...
class H4CodeSourceLiveProbeTests(unittest.TestCase):
    ...
    def test_source_modules_normalize_payloads(self):
        for source_id in H4_SOURCE_IDS:
            module = importlib.import_module(f"archive.prototypes.legacy_runtime.connectors.h4_code_source_release.live_probe_{source_id}")
