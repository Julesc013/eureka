...
from runtime.connectors.h8_manuals_docs_standards.fixture_loader import load_h8_manuals_docs_fixture
from runtime.connectors.h8_manuals_docs_standards.normalizer_common import H8_FIXTURE_KINDS, H8_SOURCE_IDS
...
class H8ManualsDocsFixtureRuntimeTests(unittest.TestCase):
    def test_all_normalizers_handle_all_fixture_kinds(self) -> None:
        for source_id in H8_SOURCE_IDS:
            module = importlib.import_module(f"runtime.connectors.h8_manuals_docs_standards.{source_id}")
    ...
    def test_missing_optional_fields_produce_limitations(self) -> None:
        ...
        normalized = importlib.import_module("runtime.connectors.h8_manuals_docs_standards.bitsavers_docs").normalize(fixture)
