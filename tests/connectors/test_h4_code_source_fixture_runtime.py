...
from runtime.connectors.h4_code_source_release.normalizer_common import H4_FIXTURE_KINDS, H4_SOURCE_IDS
...
class H4CodeSourceFixtureRuntimeTests(unittest.TestCase):
    ...
    def test_missing_optional_fields_produce_limitations(self):
        ...
        normalized = importlib.import_module("runtime.connectors.h4_code_source_release.github_repository").normalize(fixture)
