...
from control.prototypes.legacy_runtime.connectors.h5_vendor_update_driver.fixture_loader import load_h5_vendor_update_fixture
from control.prototypes.legacy_runtime.connectors.h5_vendor_update_driver.normalizer_common import H5_FIXTURE_KINDS, H5_SOURCE_IDS
...
class H5VendorUpdateFixtureRuntimeTests(unittest.TestCase):
    def test_all_normalizers_handle_all_fixture_kinds(self) -> None:
        for source_id in H5_SOURCE_IDS:
            module = importlib.import_module(f"control.prototypes.legacy_runtime.connectors.h5_vendor_update_driver.{source_id}")
    ...
    def test_missing_optional_fields_produce_limitations(self) -> None:
        ...
        normalized = importlib.import_module("control.prototypes.legacy_runtime.connectors.h5_vendor_update_driver.microsoft_download_center").normalize(fixture)
