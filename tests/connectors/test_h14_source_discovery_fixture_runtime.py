...
from control.prototypes.legacy_runtime.connectors.h14_source_discovery.normalizer_common import H14_FIXTURE_FILES, H14_SOURCE_IDS
...
class H14SourceDiscoveryFixtureRuntimeTests(unittest.TestCase):
    ...
    def test_all_normalizers_handle_minimal_and_policy_blocked_fixtures(self) -> None:
        for source_id in H14_SOURCE_IDS:
            ...
            module = importlib.import_module(f"control.prototypes.legacy_runtime.connectors.h14_source_discovery.{module_name}")
    ...
    def test_all_fixture_kinds_normalize_for_source_need_registry(self) -> None:
        module = importlib.import_module("control.prototypes.legacy_runtime.connectors.h14_source_discovery.source_need_registry")
