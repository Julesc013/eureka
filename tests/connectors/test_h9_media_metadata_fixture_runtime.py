...
from archive.prototypes.legacy_runtime.connectors.h9_media_metadata.normalizer_common import (
    H9_FIXTURE_KINDS,
    H9_SOURCE_IDS,
...
class H9MediaMetadataFixtureRuntimeTests(unittest.TestCase):
    def test_all_normalizers_handle_all_fixture_kinds(self) -> None:
        for source_id in H9_SOURCE_IDS:
            module = importlib.import_module(f"archive.prototypes.legacy_runtime.connectors.h9_media_metadata.{source_id}")
    ...
    def test_missing_optional_fields_produce_limitations_not_fabricated_data(self) -> None:
        ...
        normalized = importlib.import_module("archive.prototypes.legacy_runtime.connectors.h9_media_metadata.musicbrainz").normalize(fixture)
