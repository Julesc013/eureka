...
from runtime.connectors.h5_vendor_update_driver.live_probe_common import (
    H5_SOURCE_IDS,
    SOURCE_CONFIGS,
...
class H5VendorUpdateLiveProbeTests(unittest.TestCase):
    ...
    def test_source_modules_normalize_payloads(self):
        for source_id in H5_SOURCE_IDS:
            module = importlib.import_module(f"runtime.connectors.h5_vendor_update_driver.live_probe_{source_id}")
