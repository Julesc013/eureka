...
from archive.prototypes.legacy_runtime.connectors.h6_web_archive_news_event.live_probe_common import (
    H6_SOURCE_IDS,
    SOURCE_CONFIGS,
...
class H6WebArchiveLiveProbeTests(unittest.TestCase):
    ...
    def test_source_modules_normalize_payloads(self):
        for source_id in H6_SOURCE_IDS:
            module = importlib.import_module(f"archive.prototypes.legacy_runtime.connectors.h6_web_archive_news_event.live_probe_{source_id}")
