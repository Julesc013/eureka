...
from runtime.connectors.h10_games_emulation.scummvm_compatibility import normalize as normalize_scummvm
from runtime.connectors.h10_games_emulation.redump_hash_sets import normalize as normalize_redump
