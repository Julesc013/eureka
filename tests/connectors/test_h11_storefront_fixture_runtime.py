...
from control.prototypes.legacy_runtime.connectors.h11_storefront.normalizer_common import H11_SOURCE_IDS, detect_h11_product_boundary_violations, detect_h11_truth_boundary_violations
...
class H11StorefrontFixtureRuntimeTests(unittest.TestCase):
    ...
    def test_missing_optional_fields_are_limited_not_fabricated(self) -> None:
        ...
        record = importlib.import_module("control.prototypes.legacy_runtime.connectors.h11_storefront.fdroid_metadata").normalize(fixture)
