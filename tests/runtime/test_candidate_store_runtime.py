...
class CandidateStoreRuntimeTests(unittest.TestCase):
    def test_build_candidate_record_works_on_search_need_example(self) -> None:
        record = candidate_store.build_candidate_record(_json("examples/search/needs/software_version_search_need_v0.json"))
    ...
    def test_source_lead_candidate_classifies_correctly(self) -> None:
        record = candidate_store.build_candidate_record(_json("examples/index/candidates/source_lead_candidate_v0.json"))
    ...
    def test_workunit_result_candidate_classifies_correctly(self) -> None:
        record = candidate_store.build_candidate_record(_json("examples/work_units/results/search_need_review_pass_v0/work_unit_result.json"))
    ...
    def test_policy_blocked_candidate_remains_policy_blocked(self) -> None:
        record = candidate_store.build_candidate_record(_json("examples/index/candidates/policy_blocked_candidate_v0.json"))
    ...
    def test_duplicate_possible_candidate_is_not_merged(self) -> None:
        records = [
            _json("examples/index/candidates/search_need_candidate_v0.json"),
            _json("examples/index/candidates/duplicate_possible_candidate_v0.json"),
        ]
    ...
    def test_candidate_truth_boundary_violation_is_rejected(self) -> None:
        record = candidate_store.build_candidate_record(_json("examples/index/candidates/minimal_candidate_v0.json"))
    ...
    def test_runtime_does_not_call_network_model_or_provider(self) -> None:
        with mock.patch("socket.create_connection", side_effect=AssertionError("network call blocked")):
            record = candidate_store.build_candidate_record(_json("examples/search/needs/driver_search_need_v0.json"))
    ...
    def test_runtime_does_not_mutate_master_index_or_create_private_roots(self) -> None:
        ...
        snapshot = candidate_store.build_candidate_store_snapshot([_json("examples/index/candidates/minimal_candidate_v0.json")])
