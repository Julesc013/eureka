...
class LocalWorkbenchViewModelTests(unittest.TestCase):
    def test_home_view_uses_status_summary(self) -> None:
        ...
        self.assertTrue(view.non_claim_banner.messages)
        self.assertTrue(view.unavailable_capabilities)
    ...
    def test_search_view_contains_presentation_data_only(self) -> None:
        view = build_search_page_view(
            "demo",
            {
                ...
                "results": [
                    {
                        "record_id": "r1",
                        "source_cache_entry_id": "sce1",
                        "evidence_id": "ev1",
                        "review_item_id": "ri1",
                        "review_decision_id": "rd1",
                    }
                ],
            },
        )
        ...
        self.assertEqual(4, len(view.results[0].provenance_refs))
    ...
    def test_object_view_has_found_and_not_found_states(self) -> None:
        found = build_object_page_view("r1", {"record_id": "r1", "title": "Demo", "normalized_fields": {"name": "Demo"}})
        missing = build_object_page_view("r2", None)
        self.assertTrue(found.found)
        self.assertEqual("name", found.normalized_fields[0]["field"])
    ...
    def test_source_view_defaults_to_empty_records(self) -> None:
        ...
        self.assertIn("local", view.local_scope_note)
    ...
    def test_absence_view_does_not_overclaim(self) -> None:
        ...
        self.assertEqual(("reviewed_public_index",), view.checked_layers)
        self.assertIn("source probes", view.unchecked_layers)
    ...
    def test_status_view_keeps_disabled_runtime_flags(self) -> None:
        ...
        self.assertFalse(view.production_readiness_claimed)
        self.assertFalse(view.public_launch_readiness_claimed)
