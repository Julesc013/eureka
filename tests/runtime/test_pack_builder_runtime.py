...
class PackBuilderRuntimeTest(unittest.TestCase):
    def test_source_pack_draft_builds_from_source_cache_record(self):
        record = load_json("examples/source_cache_records/source_metadata_record_v0.json")
    ...
    def test_evidence_pack_draft_builds_from_evidence_record(self):
        record = load_json("examples/evidence_ledger_records/metadata_claim_record_v0.json")
    ...
    def test_contribution_pack_draft_builds_from_candidate_and_review(self):
        ...
        review = load_json("examples/review_queue_entries/candidate_needs_review_v0.json")
    ...
    def test_index_pack_preview_remains_preview_only(self):
        proposal = load_json("examples/reviewed_public_records/minimal_reviewed_public_record_proposal_v0.json")
    ...
    def test_policy_blocked_pack_case_remains_blocked(self):
        record = load_json("examples/evidence_ledger_records/policy_blocked_evidence_record_v0.json")
    ...
    def test_runtime_has_no_network_or_model_imports(self):
        tree = ast.parse((REPO_ROOT / "runtime/local_foundry/pack_builder.py").read_text(encoding="utf-8"))
