...
`contracts/pack/` defines governed portable bundle formats for future
...
Master-index review queue contracts now live under `contracts/index/master/`
...
AI Provider Contract v0 lives under `contracts/ai/`, not `contracts/pack/`.
